...
output.setNal(al);
			...
			output.setAction("/iri/Publicidad.do?state=buscarXNroPartida");			
...
output.setNal(al);
			...
			output.setAction("/iri/Publicidad.do?state=buscarXFicha");
			req.setAttribute("output", output);
...
output.setNal(al);
			...
			output.setAction("/iri/Publicidad.do?state=buscarXTomoFolio");				
			req.setAttribute("output", output);
...
//				poolLocal.release(connLocal);
	...
	public ControllerResponse runBuscarXFichaRMCState(
		...
		try {
			...
			output.setAction("/iri/Publicidad.do?state=buscarXFichaRMC");
	...
	public ControllerResponse runBuscarXNroPartidaRMCState(
			...
			try {
				...
				output.setAction("/iri/Publicidad.do?state=buscarXNroPartidaRMC");
		...
		public ControllerResponse runBuscarXTomoFolioRMCState(
			...
			try {
				...
				output.setAction("/iri/Publicidad.do?state=buscarXTomoFolioRMC");
		...
		public ControllerResponse runDetallePartidaRMCState(
				...
				try {
					...
					output.setAction("/iri/Publicidad.do?state=detallePartidaRMC");
