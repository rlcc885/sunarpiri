...
public class BuscarXIndiceController extends ControllerExtension implements Constantes {
	...
	public ControllerResponse runVerFormularioState(
		...
		try {
			...
			/*
			El combo Tipo participacion se forma de un join:

			//nuevo join 9 sep2002
			select  DISTINCT t1.area_reg_id, t2.cod_partic, t2.nombre
			from
			tm_libro t1,
			partic_libro t2
			where t1.cod_libro = t2.cod_libro

			el "distinct" se hace por programacion
			*/




/*comentado 9 dic 2002 porque en la pantalla JSP ya no se muestra el
combo box de participación
			...
			multi.addDBObj("gob.pe.sunarp.extranet.dbobj.DboTmLibro", "t1");
			multi.addDBObj("gob.pe.sunarp.extranet.dbobj.DboParticLibro", "t2");
			multi.setForeignKey("t1",DboTmLibro.CAMPO_COD_LIBRO,"t2",DboParticLibro.CAMPO_COD_LIBRO);


			multi.setField("t1",DboTmLibro.CAMPO_ESTADO,"1");
			multi.setField("t2",DboParticLibro.CAMPO_ESTADO,"1");

			java.util.Vector resultado = multi.searchAndRetrieve();


			java.util.ArrayList resultado2 = new java.util.ArrayList();
			boolean existe = false;
			for (int i = 0; i < resultado.size(); i++) {
				MultiDBObject oneMulti = (MultiDBObject) resultado.get(i);
				String codArea = oneMulti.getField("t1", DboTmLibro.CAMPO_AREA_REG_ID);
				// hp
				String codPartic = oneMulti.getField("t2", DboParticLibro.CAMPO_COD_PARTIC);
				String desPartic = oneMulti.getField("t2", DboParticLibro.CAMPO_NOMBRE);
				// hp
				// String codPartic = oneMulti.getField("t2", DboTmTipoPartic.CAMPO_COD_PARTIC);
				// String desPartic = oneMulti.getField("t2", DboTmTipoPartic.CAMPO_NOMBRE);


				//if (isTrace(this)) System.out.println("resultado bruto = " + codArea + "\t" + codPartic + "\t" + desPartic);




				//buscar en arreglo final
				existe = false;
				for (int j = 0; j < resultado2.size(); j++) {
					Value05Bean b5 = (Value05Bean) resultado2.get(j);
					if (b5.getValue01().equals(codPartic) &&
					    b5.getValue03().equals(codArea)   &&
					    b5.getValue02().equals(desPartic)
					    )
					{
						existe = true;
						break;
				...
				if (existe == false) {
					Value05Bean bean05 = new Value05Bean();
					bean05.setValue01(codPartic);
					bean05.setValue02(desPartic);
					bean05.setValue03(codArea);
					resultado2.add(bean05);
				}
			}
			//resultado2 contiene el Resultado final (distinct programado)
*/
		...
		throws ControllerException
	{
		...
		try {
			...
			output.setAction("/iri/BuscaPartidasXIndices.do?state=buscarPersonaNaturalRmc&tipo=N");
	...
	public ControllerResponse runBuscarPersonaNaturalState(ControllerRequest request,
			ControllerResponse response)
		throws ControllerException
	{
...
//				qcb.append(" and nombres like '").append(nombre).append("%' ");///made by Leo
		...
		throws ControllerException
	{
		...
		try {
			...
			output.setAction("/iri/BuscaPartidasXIndices.do?state=buscarPersonaJuridicaRmc&tipo=J");
		...
		throws ControllerException
	{
		...
		try {
			...
			output.setAction("/iri/BuscaPartidasXIndices.do?state=buscarTipoNumeroDocumentoRmc&tipo=D");
 ...
 /**** inicio: jrosas: 13-07-07 ******/
		...
		throws ControllerException
	{
		...
		try {
			...
			output.setAction("/iri/BuscaPartidasXIndices.do?state=buscarBienesRmc&tipo=B");
...
output.setAction("/iri/BuscaPartidasXIndices.do?state=buscarPersonaJuridica");
req.setAttribute("output", output);
	...
	public ControllerResponse runBuscarRazonSocialState(ControllerRequest request, ControllerResponse response)	throws ControllerException {
		...
		output.setAction("/iri/BuscaPartidasXIndices.do?state=buscarRazonSocial");
		req.setAttribute("output", output);
...
output.setNal(al);
		...
		req.setAttribute("fechaAct",fechaAct);
			...
			output.setAction("/iri/BuscaPartidasXIndices.do?state=buscarPredio");
			req.setAttribute("output", output);
...
output.setNal(al);
		...
		req.setAttribute("fechaAct",fechaAct);
			...
			output.setAction("/iri/BuscaPartidasXIndices.do?state=buscarMineria");
			req.setAttribute("output", output);
...
output.setNal(al);
		...
		req.setAttribute("fechaAct",fechaAct);
			...
			output.setAction("/iri/BuscaPartidasXIndices.do?state=buscarEmbarcacion");
			req.setAttribute("output", output);
...
output.setNal(al);
		...
		req.setAttribute("fechaAct",fechaAct);
		   ...
		   // Fin:mgarate:31/05/2007
			...
			output.setAction("/iri/BuscaPartidasXIndices.do?state=buscarBuque");
			req.setAttribute("output", output);
...
output.setNal(al);
		...
		req.setAttribute("fechaAct",fechaAct);
			...
			output.setAction("/iri/BuscaPartidasXIndices.do?state=buscarAeronaveXMatricula");
			req.setAttribute("output", output);
			// Inicio:mgarate:31/05/2007
			   req.setAttribute("criterioBusqueda",criterioBusqueda);
			   req.setAttribute("flagCertBusq",bean1.getCodGrupoLibroArea());
...
output.setNal(al);
		...
		req.setAttribute("fechaAct",fechaAct);
			...
			output.setAction("/iri/BuscaPartidasXIndices.do?state=buscarAeronaveXNombre");
			req.setAttribute("output", output);
...
public ControllerResponse runBuscarXNombreVehicularState(ControllerRequest request,ControllerResponse response)
	...
	else
	{
		...
		*/
		...
		//output.setAction("/iri/BuscaPartidasXIndices.do?state=buscarPersonaNatural");
		output.setAction("/iri/BuscaPartidasXIndices.do?state=buscarXNombreVehicular");
		req.setAttribute("output", output);
...
public ControllerResponse runBuscarXNombreVehicularJuriState(ControllerRequest request,ControllerResponse response)
	...
	else
	{
		...
		*/
		...
		output.setAction("/iri/BuscaPartidasXIndices.do?state=buscarXNombreVehicularJuri");
		req.setAttribute("output", output);
		// Inicio:mgarate:31/05/2007
		   req.setAttribute("criterioBusqueda",criterioBusqueda);
		   req.setAttribute("flagCertBusq",bean1.getCodGrupoLibroArea());
...
public ControllerResponse runBuscarXNombreVehicularMotorState(ControllerRequest request,ControllerResponse response)
	...
	else
	{
		...
		*/
		...
		output.setAction("/iri/BuscaPartidasXIndices.do?state=buscarXNombreVehicularMotor");
		req.setAttribute("output", output);
...
//					}
	...
	else
	{
		...
		*/
		...
		output.setAction("/iri/BuscaPartidasXIndices.do?state=buscarXNombreVehicularChasis");
		req.setAttribute("output", output);
		...
		throws ControllerException
	{
		...
		try
		{
			...
			output.setAction("/iri/BuscaPartidasXIndices.do?state=buscarPersonaNaturalSigc&tipo=N");
		...
		throws ControllerException
	{
		...
		try
		{
			...
			output.setAction("/iri/BuscaPartidasXIndices.do?state=buscarPersonaJuridicaSigc&tipo=J");
			req.setAttribute("outnumber",bean.getCantidad());
			req.setAttribute("tarifa",output.getTarifa());
			req.setAttribute("usuaEtiq", usuario.getUserId());
			req.setAttribute("fechaAct", FechaFormatter.deDateAFechaHoraWeb(new java.util.Date()));
		...
		throws ControllerException
	{
		...
		try
		{
			...
			output.setAction("/iri/BuscaPartidasXIndices.do?state=buscarTipoNumeroDocumentoSigc&tipo=D");
			req.setAttribute("outnumber",bean.getCantidad());
			req.setAttribute("tarifa",output.getTarifa());
			req.setAttribute("usuaEtiq", usuario.getUserId());
			req.setAttribute("fechaAct", FechaFormatter.deDateAFechaHoraWeb(new java.util.Date()));
		...
		throws ControllerException
	{
		...
		try
		{
			...
			output.setAction("/iri/BuscaPartidasXIndices.do?state=buscarBienesSigc&tipo=B");
			req.setAttribute("outnumber",bean.getCantidad());
			req.setAttribute("tarifa",output.getTarifa());
			req.setAttribute("usuaEtiq", usuario.getUserId());
			req.setAttribute("fechaAct", FechaFormatter.deDateAFechaHoraWeb(new java.util.Date()));
