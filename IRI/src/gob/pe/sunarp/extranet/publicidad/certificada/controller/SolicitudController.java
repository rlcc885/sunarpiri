...
public class SolicitudController extends ControllerExtension implements Constantes
{
	...
	private void muestraDocsId(ControllerRequest request,DBConnection dconn) throws DBException
	{
	  ...
	  /* inicio:jrosas 06-06-2007
	   SUNARP-REGMOBCOM: agregacion de metodo carga inicial de combo de certificados  */
		...
		throws ControllerException 
	{
		...
		try{
		   ...
		   /* inicio:jrosas 06-06-2007
		   SUNARP-REGMOBCOM: obtencion del tipo de certificado por request: N(POSTIVO/NEGATIVO),V(VIGENCIA),G(GRAVAMEN),
		   D(DOMINIAL),C(CREM)  */
