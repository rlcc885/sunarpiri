...
public class Visa extends ControllerExtension {

	private String thisClass = Visa.class.getName() + ".";
		...
		try {
			...
			*/
			...
			if(request.getParameter("CODTIENDA")!=null){
				String p1 = "1";		
				String p2 = request.getParameter("CODTIENDA");
				String p3 = request.getParameter("NUMORDEN");
				String p4 = "0";	
							
				String parametros = gob.pe.sunarp.extranet.util.DirVisa.getInstance().getDirDesa() +"IncrementarSaldo.do?state=resultadoAbonoCredito&respuesta=" + p1 +"&cod_tienda=" + p2 + "&nordent=" + p3 + "&codaccion="+ p4;
