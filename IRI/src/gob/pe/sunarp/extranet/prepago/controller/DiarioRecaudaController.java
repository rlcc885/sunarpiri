...
public class DiarioRecaudaController extends ControllerExtension implements Constantes{
	private String thisClass = DiarioRecaudaController.class.getName() + ".";

	public DiarioRecaudaController() 
	{
		super();
	...
	{
		return new String("DiarioRecaudaController");
	}
...
//*PAGINACION EN EL JSP*//
			...
			//
			//estado comentado para que pueda sumar TODOS
		...
		//	if(user.getPerfilId() == Constantes.PERFIL_TESORERO)
	//			request.setAttribute("muestraDiarioRecau","S");
