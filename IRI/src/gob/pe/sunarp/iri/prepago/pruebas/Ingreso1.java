package gob.pe.sunarp.iri.prepago.pruebas;
		...
		try {
			...
			*/
			...
			if(request.getParameter("CODTIENDA")!=null){
				...
				String parametros = gob.pe.sunarp.extranet.util.DirVisa.getInstance().getDirDesa()+"IncrementarSaldoIRI.do?state=resultadoAbonoCredito&cod_tienda=" + p1 + "&nordent=" + p2 + "&respuesta=1";
			...
			//Para Debito
				...
				String r4 = "00991";
				String r5 = "00000";
				String parametros = gob.pe.sunarp.extranet.util.DirVisa.getInstance().getDirDesa()+"IncrementarSaldoIRI.do?state=resultadoAbonoDebito&D0=" + d0 + "&R1=" + r1 + "&R2=" + r2 + "&R3=" + r3 + "&R4=" + r4 + "&R5=" + r5;
				urlParams = new Output("urlParams", parametros);
			}
