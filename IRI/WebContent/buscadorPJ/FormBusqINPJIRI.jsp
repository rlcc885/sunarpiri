...
<script language="JavaScript" src="../../buscadorPJ/javascript/util.js"></script>
	...
	<LINK REL="stylesheet" type="text/css" href="<%=request.getContextPath()%>/buscadorPJ/styles/global.css">
	<link href="<%=request.getContextPath()%>/styles/iri.css" rel="stylesheet" type="text/css">
	<script language="JavaScript" src="<%=request.getContextPath()%>/buscadorPJ/javascript/util.js"></script>
