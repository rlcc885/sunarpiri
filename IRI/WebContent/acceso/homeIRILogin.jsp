        ...
        <table width="220" border="0" cellspacing="0" cellpadding="1">
          ...
          <tr > 
            <td width="40%" align="right"><strong>Usuario 
              :</strong></td>
            <td align="center"><input name=user type="text" size="11" maxlength="13" style="width:96px;height:22px;font-family:Arial,'Lucida Sans','Trebuchet MS',Verdana,Helvetica,sans-serif;text-transform: uppercase" onblur="this.value.toUpperCase()" value="INFORMATICA">
          </tr>
          <tr > 
