...
<div id="framecontentTop">
  ...
  <br><br><br><br><br>
	...
	<tr align="right"> 
	      <td>
	        <a class="linkInicio" href="acceso/InfoStatic/PrivacSeg.html" target="main_frame1" onMouseOver="MM_swapImage('top1','','<%=request.getContextPath()%>/images/opc_top01x.gif',1)" onMouseOut="MM_swapImgRestore()">
	        ...
	        &nbsp;
	        <a class="linkInicio" href="acceso/t_condiciones.htm" target="main_frame1" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('top3','','<%=request.getContextPath()%>/images/opc_top03x.gif',1)">
	          <!-- img src="<%=request.getContextPath()%>/images/opc_top03.gif" border="0" name="top3"-->
	          Términos y Condiciones
	        </a>
	        &nbsp;
	        <a class="linkInicio" href="javascript:Abrir_Ventana('acceso/Contactenos.html','Contactenos','',415,280)" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('top4','','<%=request.getContextPath()%>/images/opc_top04x.gif',1)">
	          <!-- img src="<%=request.getContextPath()%>/images/opc_top04.gif" border="0" name="top4"-->
	          Contáctenos
	        </a>
	        &nbsp;
	        <a class="linkInicio" href="acceso/frm_tarifas.htm" target="_top" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('top6','','<%=request.getContextPath()%>/images/opc_top06x.gif',1)">
	          <!-- img src="<%=request.getContextPath()%>/images/opc_top06.gif" name="top6" border="0"-->
	          Tarifas
	        </a>
	        &nbsp;
	        <a class="linkInicio" href="acceso/displayLoginIRI.html" target="_top" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('top5','','<%=request.getContextPath()%>/images/opc_top05x.gif',1)">
