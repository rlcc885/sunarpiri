...
function continuar()
{ 
//	window.open("/iri/Afiliacion.do?state=mostrarOpcionPagoOrg",target="_self")
///	location.href="/iri/Afiliacion.do?state=mostrarOpcionPagoOrg";
	document.form1.method="post";
	document.form1.action="/iri/Afiliacion.do?state=mostrarOpcionPagoOrg";
...
{ 
	document.form1.method="post";
	document.form1.action="/iri/Afiliacion.do?state=aceptarContratoOrg";
	document.form1.submit();
	//window.open("/iri/Afiliacion.do?state=aceptarContratoOrg",target="_self")
	//location.href="/iri/Afiliacion.do?state=aceptarContratoOrg";
}

function NoAcepto()
{ 
	//window.open("../afiliacion/NoAcepto.jsp",target="_top");
...
{ 
	document.form1.method="post";
	document.form1.action="/iri/Afiliacion.do?state=regresarOrg";
	document.form1.submit();	
}
...
<table class="titulo">
  <tr>
    <td>Afiliaci&oacute;n de Organizaci&oacute;n (Paso 2 de 3)</td>
  </tr>
</table>
<br>
...
<span style="font-size: 7.0pt; font-family: Arial; color: black" lang="ES">FECHA     : 
</span><span style="font-size: 7.0pt; font-family: Arial" lang="ES"><font color="#990000"><%=request.getAttribute("fecha_hora_sistema")%></font></span>
<span style="font-size: 7.0pt; font-family: Arial; color: black" lang="ES">USUARIO
ID: </span><span style="font-size: 7.0pt; font-family: Arial" lang="ES"><font color="#990000"><%=request.getAttribute("usr_id")%>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
</font>CONTRATO <font color="#990000">: <%=request.getAttribute("num_contrato")%>&nbsp;&nbsp; </font>VERSION
:&nbsp;<font color="#990000"> <%=request.getAttribute("version_contrato")%></font></span>
<p class="MsoNormal" style="text-align:justify"><span style="font-size: 7.0pt; font-family: Arial; color: black" lang="ES">ORGANIZACION
: </span><span style="font-size: 7.0pt; font-family: Arial" lang="ES"><font color="#990000"><%=request.getAttribute("organizacion")%>
</font></span></p>
<p class="MsoNormal" style="text-align:justify"><span style="font-size: 7.0pt; font-family: Arial; color: black" lang="ES">APELLIDOS
Y NOMBRE DEL REPRESENTANTE : </span><span style="font-size: 7.0pt; font-family: Arial" lang="ES"><font color="#990000"><%=request.getAttribute("anrep")%>
&nbsp;</font></span><span style="font-size: 7.0pt; font-family: Arial; color: black" lang="ES">&nbsp;
<%=request.getAttribute("tipoDocumentoRep")%> : </span><span style="font-size: 7.0pt; font-family: Arial" lang="ES"><font color="#990000"><%=request.getAttribute("numeroDocumentoRep")%></font></span></p>
<p class="MsoNormal" style="text-align:justify"><span style="font-size: 7.0pt; font-family: Arial" lang="ES">APELLIDOS
Y NOMBRE DEL ADMINISTRADOR <font color="#990000"> : <%=request.getAttribute("anadm")%></font>&nbsp;  <%=request.getAttribute("tipoDocumentoAdm")%>:<font color="#990000">
<%=request.getAttribute("numeroDocumentoAdm")%></font></span>
</p>
