...
<table class=formularioimpresion>
  ...
  <tr>
    <td width="10%" height="12" ></td>
    <td width="90%" height="20" colspan="4" class="textoSolicitud"></td>
  </tr>
  ...
  <tr>
    ...
    Es grato dirigirme a usted, a fin de informale que habiendo sido previamente verificado por esta Sub-Gerencia y en m&eacute;rito al Oficio Circular No. 457-2003-SUANRP/GL-SG (12.06.2003),
    alcanzo al presente las hojas de tr&aacute;mite  <bean:write name="solDev" property="numHojaTramite"/> (<bean:write name="solDev" property="fechaTramite"/>), respectivamente sobre devoluci&oacute;n de Derechos Registrales correspondiente al
    presente ejercicio para su aprobaci&oacute;n y proyecto de Resoluci&oacute;n de Gerencia respectiva por <b>Pago Indebido de Publicidad Registral en Línea</b>
  ...
  <tr>
  	<td width="10%" height="14" ></td>
    <th width="65%" height="14" align="left" class="textoSolicitud" colspan="2"><b>Interesado</b></th>
    <th width="15%" height="14" align="right" class="textoSolicitud" ><b>Importe </b></th>
    <td width="10%" height="14" ></td>
  </tr>
  <tr>
  	<td width="10%" height="14" ></td>
    <td width="65%" height="14" class="textoSolicitud" colspan="2"><bean:write name="comprobante" property="nombreEntidad"/></td>   
    <td width="15%" height="14" align="right" class="textoSolicitud">S/. <u><bean:write name="comprobante" property="monto"/></u></td> 
    <td width="10%" height="14" ></td>
  </tr>
  <tr>
    <td width="100%" height="80" colspan="5"></td>
  </tr>
   <tr>
    <td width="10%" height="14" ></td>
    <td width="90%" height="14"colspan="5" align="left" class="textoSolicitud"> 
  ...
  <tr>
    <td width="100%" height="80" align="right" colspan="5" class="textoSolicitud">Atentamente,</td>
  </tr>
  
  
  <tr>
    <td width="100%" height="155" colspan="5"></td>
  </tr>
  <tr>
