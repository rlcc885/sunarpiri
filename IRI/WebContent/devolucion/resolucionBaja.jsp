...
<table class=formularioimpresion>
  ...
  <tr>
    ...
    <p align="justify" class="textoSolicitud">
     ...
     la hoja de tr&aacute;mite No. <bean:write name="solDev" property="anoHojaTramite"/>-<bean:write name="solDev" property="numHojaTramite"/> (<bean:write name="solDev" property="fechaTramite"/>)
  ...
  <tr>
   ...
   <tr>
    ...
    <p align="justify" class="textoSolicitud">
     ...
     <br>
     <br>
     Que, mediante el documento del visto el recurrente en su condici&oacute;n de presentante solicita la devoluci&oacute;n de dinero 
  ...
  <tr>
   ...
   <tr>
    ...
    <td height="14" colspan="3">
    <p align="justify" class="textoSolicitud">
      Que, estando a lo opinado por la Sub-Gerencia de Contabilidad y Finanzas con Nº. de Informe
       <bean:write name="solDev" property="numInforme"/> de <bean:write name="solDev" property="fechaInforme"/> 
   ...
   <tr>
    ...
    <p align="justify" class="textoSolicitud">
      <br>
      <B>Artículo 1&ordm;</B> Autorizar a la Oficina de Tesorer&iacute;a de la Sub-Gerencia de Contabilidad y Finanzas la Devoluci&oacute;n
  ...
  <tr>
  	<td width="10%" height="14" ></td>
    <th height="14" align="center"  class="textoSolicitud" width="17%"><b>Interesado</b></th>
    <th height="14" align="center"  class="textoSolicitud" width="12%"><b>Importe </b></th>
    <td width="10%" height="14" ></td>
  </tr>
  <tr>
  	<td width="10%" height="14" ></td>
    <td height="14" class="textoSolicitud" align="center" width="17%"><bean:write name="comprobante" property="nombreEntidad"/></td>   
    <td height="14" align="center" class="textoSolicitud" width="12%">S/.<u><bean:write name="comprobante" property="monto"/></u></td> 
    <td width="10%" height="14" ></td>
  </tr>
  <tr>
  ...
  <tr>
    ...
    <td height="14" colspan="3">
    <p align="justify" class="textoSolicitud">
      <B>Artículo 2&ordm;</B> Disponer que las devoluciones se atiendan con cargo a cuenta corriente Nº 00-000-304808
