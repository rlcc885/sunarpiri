...
function Asociar(solId,indice)
{
	 ...
	 if(document.form1.numHojaTram[0]==null){ // cuando hay 1 solicitud
		if(document.form1.numHojaTram.value.length>0 && document.form1.fecHojaTram.value.length>0){
			...
			alert("Debe ingresar los datos de la hoja trámite");
			return false;
		}		
	}else {//mas de 1
	...
	if(confirm("Se Asociará el Número y Fecha de Hoja de Trámite. \n \n Está seguro de realizar la operación ?")){
	document.form1.method="POST";
...
function AsociarInforme(solId,indice)
{
	if(document.form1.numInforme[0]==null){ // cuando hay 1 solicitud
		if(document.form1.numInforme.value.length>0){
			...
			alert("Debe ingresar el número de informe");
			return false;
		}		
	}else {//mas de 1
	...
	if(confirm("Se Asociará el Número de Informe de Devolución. \n \n Está seguro de realizar la operación ?")){
	document.form1.method="POST";
...
function AsociarResolucion(solId,indice)
{
	 ...
	 if(document.form1.numResolucion[0]==null){ // cuando hay 1 solicitud
		if(document.form1.numResolucion.value.length>0){
			...
			alert("Debe ingresar el número de la resolucion");
			return false;
		}		
	}else {//mas de 1
	...
	if(confirm("Se Asociará el número de hoja de resolución \n \n Está seguro de realizar la operación ?")){
		document.form1.method="POST";
...
{ 
	...
	alert("El formato del número de la hoja de trámite no es correcto");
	control.focus();
	return false;
}
...
<tr>
  ...
  <tr>
    ...
    <th width="15%" align="center" height="12">Informe de Devoluci&oacute;n<BR>ejm.(100-2007-SUNARP-Z.R.NºIX/GAF)
			</th>
    <th width="15%" align="center" height="12">Resoluci&oacute;n<BR>ejm.(100-2007-SUNARP-Z.R.NºIX/GAF)
			</th>
