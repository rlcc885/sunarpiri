...
function Buscar() {
	document.form1.method="POST";
	document.form1.action="/iri/DevolucionesTesorero.do?state=buscaSolicitudDev";
	document.form1.submit();
}

function pagar(solDev, solId){
	
	var p = confirm("¿Esta seguro de efectuar el pago?");
	if (p == true){
		document.form1.hidNumSolDev.value = solDev;
		document.form1.solicitudId.value = solId;
		document.form1.method = "POST";
		document.form1.action = "/iri/DevolucionesTesorero.do?state=pagar";
		document.form1.submit();
	}
...
<br>
<table class=formulario width="626" border="0">
  <tr>
...
<tr>
  ...
  <tr>
    ...
    <th width="20%" align="center" height="12">Informe de Devoluci&oacute;n</th>
    <th width="15%" align="center" height="12">Resoluci&oacute;n</th>
	  ...
	  <tr class=grilla2>
	    ...
	    <td width="10%" align="center" height="12">
  	    ...
  	    <td width="10%" align="center" valign="middle" height="12">
	  	    <table>
		  	    <tr>
			  	    <td align="center" style="border: 0px;" valign="middle" nowrap="nowrap">
			  	    	<bean:write name="item" property="estado"/>&nbsp;
			  	    </td>
			  	    <td align="center" style="border: 0px;" valign="middle">
			  	    	<logic:equal name="item" property="estado" value="<%=gob.pe.sunarp.extranet.util.Constantes.NOMBRE_ESTADO_SOL_DEV_CON_RESOLUCION%>">
				    		<a href="javascript:pagar('<bean:write name="item" property="idSolicitudDev"/>','<bean:write name="item" property="solicitudId"/>');"><img src="images/btn_pagar.gif"></a>
						</logic:equal>
			  	    </td>
		  	    </tr>
	  	    </table>
