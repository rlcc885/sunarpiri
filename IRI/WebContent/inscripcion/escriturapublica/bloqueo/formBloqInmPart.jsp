...
function Validar() 
{
	...
	document.frm1.action="/iri/BloqueoInmueble.do?state=agregarParticipante";		
...
function llenaComboProvincia(){
	...
	document.frm1.action="/iri/BloqueoInmueble.do?state=obtenerProvincia";
	document.frm1.submit();
}
...
function llenaComboDistrito(){
	...
	document.frm1.action="/iri/BloqueoInmueble.do?state=obtenerDistrito";
	document.frm1.submit();
}
...
<br>
	<table cellspacing=0 class=titulo>
  		<tr>
			<td>
				<FONT COLOR="black">SOLICITUDES <font size="1">&gt;&gt;</font></FONT><font color="900000"> Solicitud de Inscripci&oacute;n <font size="1">&gt;&gt;</font> Bloqueo de Propiedad Inmueble</FONT>
			</td>
  		</tr>
	</table>
	<br>
