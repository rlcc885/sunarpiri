...
function mostrarDatos(){
	if (document.frm1.cboTipoPersona.value=="PN") {
		...
		areaParticipanteRUC.style.visibility="visible";
		areaParticipanteRUC.style.display="";		
	}
		...
		areaParticipanteRUC.style.visibility="hidden";
		areaParticipanteRUC.style.display="none";		
	}
	else {
		areaParticipanteJuridico.style.visibility="hidden";
		areaParticipanteJuridico.style.display="none";
...
function Validar() 
{
	...
	document.frm1.action="/iri/ConstitucionEmpresa.do?state=agregarParticipante";		
...
function llenaComboProvincia(){
	...
	document.frm1.action="/iri/ConstitucionEmpresa.do?state=obtenerProvincia";
	document.frm1.submit();
}
...
function llenaComboDistrito(){
	...
	document.frm1.action="/iri/ConstitucionEmpresa.do?state=obtenerDistrito";
	document.frm1.submit();
}
...
<br>
	<table cellspacing=0 class=titulo>
  		<tr>
			<td>
				<FONT COLOR="black">SOLICITUDES <font size="1">&gt;&gt;</font></FONT><font color="900000"> Solicitud de Inscripci&oacute;n <font size="1">&gt;&gt;</font> Constituci&oacute;n de Empresa</FONT>
			</td>
  		</tr>
	</table>
	<br>
	...
	<input type="hidden" name="hidIndiceMod" value="">
  	...
  	<table class=tablasinestilo>
	    ...
	    <table width="100%">
		    ...
		    <tr>
				...
				<td width="70%">
					...
					<input name="txtEnvDire" type="text" onBlur="sololet(this)" maxlength="90" style="width:150">
				</td>
	        </tr>
	        <tr>
		...
		<div id="areaParticipanteRUC" style="visibility:hidden;display:none">
		    <% SolicitudInscripcion sol = (SolicitudInscripcion) session.getAttribute("solicitudInscripcion"); 
		    
		    if ( (sol.getPersonaJuridica()!=null) && (sol.getPersonaJuridica().getIndicadorRUC().equals("SI")) ) { %>
		    <table width="100%">
		    	<tr>
		      		<th colspan="2"><strong>DATOS REQUERIDOS PARA EL TRAMITE ELECTRONICO CON SUNAT</strong></th>
		    	</tr>      	     	
		    	<tr>
		      		<td width="30%"><strong>FECHA NACIMIENTO <font color="900000">*</font></strong></td>
		      		<td width="70%"><input type="text" name="txtSolFechaNacimiento" size="20" maxlength="130" style="width:230"></td>
		      	</tr>
		        <tr>
		      		<td width="30%"><strong>CARGO EN LA EMPRESA<BR>
		            QUE CONSTITUYE <font color="900000">*</font></strong></td>
		      		<td width="70%">
		      			<select name="cboSolCargo" size="1" style="width:230">
		  	       			<option value="00">&nbsp;</option>
		  	       			<% if (!session.getAttribute("labelTipoSociedad").equals("")) { %>
		  	       			<option value="025">GERENTE</option>
		  	       			<option value="003">APODERADO</option>
		  	       			<option value="013">DIRECTOR</option>
		  	       			<option value="080">OTROS</option>
		  	       			<option value="000">NINGUNA</option>
		  	       			<% } else if (!session.getAttribute("labelTipoSociedad").equals("E.I.R.L")) {  %> 		  	       			
		  	       			<option value="019">GERENTE</option>
		  	       			<option value="001">APODERADO</option>
		  	       			<option value="073">DIRECTOR</option>
		  	       			<option value="080">OTROS</option>
		  	       			<option value="000">NINGUNA</option>
		  	       			<% } else if (!session.getAttribute("labelTipoSociedad").equals("S.C.R.L")) {  %> 		  	       			
		  	       			<option value="022">GERENTE</option>
		  	       			<option value="003">APODERADO</option>
		  	       			<option value="012">DIRECTOR</option>
		  	       			<option value="080">OTROS</option>
		  	       			<option value="000">NINGUNA</option>
		  	       			<% } %>
		      			</select>
		    	...
		    	<tr>
		      		<td width="30%"><strong>FECHA DESDE LA CUAL SE</strong><BR>
		            <strong>OCUPA EL CARGO <font color="900000">*</font></strong></td>
		      		<td width="70%"><input type="text" name="txtSolFechaCargo" size="20" maxlength="130" style="width:230"></td>
		      	</tr>		    
			</table>
			<% } %>
		</div>
