      			...
      			<table class="tablasinestilo">
      				<tr>
			            <td width="600px">
			            	<table border=1 width="100%">
			            		<tr>
			            			<td align="center"><strong>CONSTITUCI&Oacute;N DE EMPRESA</strong></td>
			            		</tr>
			            	</table>
			            </td> 			            			            
					</tr>
      		...
      		<td>
      			<table class="tablasinestilo" border=1>
      				<tr>
			            ...
			            <td width="200" align="center"><strong>Nombre y Cargo del Notario o Funcionario que Autoriza o Autentica</strong></td>
			            <td width="200" align="center"><strong>Fecha</strong></td>            
					</tr>
      				<tr>
			            <td width="200">Escritura P&uacute;blica</td>
