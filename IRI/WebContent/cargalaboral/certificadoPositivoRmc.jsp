...
<logic:present name="Certificado" scope="request">	
	<table>
        ...
        <TR>
            ...
            <TD colspan="2" align="center">
            	...
            	<span class="cabeceraCertificadoSubTitulo"><%=bundle.getString("msn.certificado.rmc.positivo.constancia.titulo") %></span>
				
			</TD>
        </TR>
        <TR>
        	<TD colspan="3"><br><br>
	        	<span class="cabeceraCertificadoDefinicion"><%=bundle.getString("msn.certificado.rmc.positivo.constancia.asunto") %></span>
	        	<br><br>
        		<p class="cabeceraCertificadoComunDefJustify">
        		<%=bundle.getString("msn.certificado.rmc.positivo.constancia.contenido1") %> <u>
        		<logic:present name="objetoSolicitud" >
        		 ...
        		 &nbsp; <%=bundle.getString("msn.certificado.rmc.positivo.constancia.contenido2") %><br> 
        		</p>
        	</TD>
        </TR>
        <br>
	...
	<table>	
		<tr>
			<td colspan="3"><div align="justify" class="cabeceraCertificadoComunDefJustify">
				<%=bundle.getString("msn.certificado.rmc.positivo.constancia.contenido3") %> <bean:write name="Certificado" property="ofic_reg_id_verif" scope="request"/>
				<%=bundle.getString("msn.certificado.rmc.positivo.constancia.contenido4") %> 
				<%=horaSD%>
				<%=bundle.getString("msn.certificado.rmc.positivo.constancia.contenido5") %>&nbsp;
		...
		<TR>
			<TD colspan="3">
			       <p class="cabeceraCertificadoComunDef" ><BR>
					<% 
	...
	<table>	
		<tr>
			<td colspan="3"><div align="justify" class="cabeceraCertificadoComunDefJustify">
			   <%=bundle.getString("msn.certificado.rmc.positivo.constancia.baselegal") %> <BR><BR>
			    <%=bundle.getString("msn.certificado.rmc.positivo.constancia.pie1") %><br>
			    <%=bundle.getString("msn.certificado.rmc.positivo.constancia.pie2") %>
			 </div></td>
		</tr>
	</table> 
