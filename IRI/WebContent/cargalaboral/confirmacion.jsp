...
<!--table class=titulo cellspacing=0>
  <tr> 
    <td>
      <font color=black>SERVICIOS&gt;&gt; </font>Consulta de Estado de Solicitudes
    </td>
  </tr>
</table-->
<br>
...
<!--table class=cabeceraformulario cellspacing=0>
  <tr>
      <td><strong>BUSQUEDA DE SOLICITUD</strong></td>
  </tr>
</table-->
	
	<!-- inicio:dbravo:14/08/2007 -->
	<logic:present name="comprobante" scope="request">
	
		<script>
			
			var urlDestino = '/iri/CargaLaboral.do?state=comprobante';
			var ancho= 640;
			var alto= 600;
			NombreVentana=window.open(urlDestino,"NombreVentana","bar=0,toolbar=0,location=0,directories=0,status=0,menubar=0,scrollbars=1,resizable=0,width=" + ancho + ",height=" + alto + ",top=20,left=100");
	...
	<logic:present name="objetoSolicitud" scope="request">
			<logic:equal name="objetoSolicitud" property="certificado_id" value="21">
				<logic:equal name="solicitud" property="estado" value="E"> <!--  ESTADO DE SOLICITUD POR DESPACHAR=E -->
					<script>
						var tipocert = <bean:write name="objetoSolicitud" property="certificado_id" scope="request"/>;		
						var solid = <bean:write name="objetoSolicitud" property="solicitud_id" scope="request"/>;
			...
			<logic:equal name="objetoSolicitud" property="certificado_id" value="22">
			...
			<logic:equal name="objetoSolicitud" property="certificado_id" value="23">
				<logic:equal name="solicitud" property="estado" value="E">
					<script>
						var tipocert = <bean:write name="objetoSolicitud" property="certificado_id" scope="request"/>;		
						var solid = <bean:write name="objetoSolicitud" property="solicitud_id" scope="request"/>;
  ...
  <table class=formulario cellspacing=0>
    ...
    <tr> 
      <td>&nbsp;</td>
      <!--td width="111">
        <strong>Se despach&oacute; satisfactoriamente.</strong> </td-->
      <td>
      </td>
        </tr>
	<tr>
