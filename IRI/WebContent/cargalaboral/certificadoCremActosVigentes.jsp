	...
	<table>
        ...
        <TR>
            <TD colspan="2" align="center"><span class="cabeceraCertificadoEncabezado" >
            	...
            	<span class="cabeceraCertificadoTitulo"><%=bundle.getString("msn.certificado.crem.actosVigentes.constancia.tipoCertificado") %></span><BR>
            	<span class="cabeceraCertificadoSubTitulo"><%=bundle.getString("msn.certificado.crem.actosVigentes.constancia.subtipoCertificado") %></span>
				
			</TD>
        </TR>
        <TR>
        	<TD colspan="3"><br><br>
	        	<span class="cabeceraCertificadoDefinicion"><%=bundle.getString("msn.certificado.crem.actosVigentes.constancia.asunto") %></span>
	        	<br><br>
        		<span class="cabeceraCertificadoComunDef"><div align="justify">
        		<%=bundle.getString("msn.certificado.crem.actosVigentes.constancia.cabecera1") %><BR>
        		<%=bundle.getString("msn.certificado.crem.actosVigentes.constancia.cabecera2") %><br>
        		<%=bundle.getString("msn.certificado.crem.actosVigentes.constancia.cabecera3") %><br>
        		<%=bundle.getString("msn.certificado.crem.actosVigentes.constancia.cabecera4") %></span><span class="cabeceraCertificadoDefinicion">&nbsp;<%=bundle.getString("msn.certificado.crem.actosVigentes.constancia.cabecera5") %></span>
        		<logic:equal name="Certificado" property="tipo_objeto" value="N">
	        		<span class="cabeceraCertificadoDefinicion"><%=bundle.getString("msn.certificado.crem.actosVigentes.constancia.cabecera6") %></span><br><span class="cabeceraCertificadoNombrePersona"><bean:write name="Certificado" property="objeto_sol_PN"/></span>
        		</logic:equal>
				<logic:equal name="Certificado" property="tipo_objeto" value="J">
					<span class="cabeceraCertificadoDefinicion"><%=bundle.getString("msn.certificado.crem.actosVigentes.constancia.cabecera7") %></span><br><span class="cabeceraCertificadoNombrePersona"><bean:write name="Certificado" property="objeto_sol_PJ"/></span>
				</logic:equal>
        		     <span class="cabeceraCertificadoComunDef"><%=bundle.getString("msn.certificado.crem.actosVigentes.constancia.cabecera8") %></span><br> 
