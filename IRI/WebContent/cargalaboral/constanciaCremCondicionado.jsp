...
<%
	if(request.getAttribute("constanciaCrem")!=null)
	{
		...
		String tipoRegistro = constanciaCremBean.getTipoRegistro();
		...
		if(ListadoPartidasRMC==null){
			ListadoPartidasRMC = new ArrayList();
		}
		if(ListadoTitulosPendientesRMC==null){
			ListadoTitulosPendientesRMC = new ArrayList();
		}
		if(ListadoAsientosVehicular==null){
			ListadoAsientosVehicular = new ArrayList();
		}
		if(ListadoTitulosPendientesVehicular==null){
			ListadoTitulosPendientesVehicular = new ArrayList();
		}
		if(ListadoAsientosEmbarcacionPesquera==null){
			ListadoAsientosEmbarcacionPesquera = new ArrayList();
		}
		if(ListadoTitulosPendientesEmbarcacionPesquera==null){
			ListadoTitulosPendientesEmbarcacionPesquera = new ArrayList();
		}
		if(ListadoAsientosBuques==null){
			ListadoAsientosBuques = new ArrayList();
		}
		if(ListadoTitulosPendientesBuques==null){
			ListadoTitulosPendientesBuques = new ArrayList();
		}
		if(ListadoAsientosAeronaves==null){
			ListadoAsientosAeronaves = new ArrayList();
		}
		if(ListadoTitulosPendientesAeronaves==null){
			ListadoTitulosPendientesAeronaves = new ArrayList();
		}
		if(ListadoAsientosPersonasJuridicas==null){
			ListadoAsientosPersonasJuridicas = new ArrayList();
		}
		if(ListadoTitulosPendientesPersonasJuridicas==null){
			ListadoTitulosPendientesPersonasJuridicas = new ArrayList();
		}
		
		StringBuffer constancia = new StringBuffer();
		
		if(tipoRegistro.indexOf("RMC")>-1){
		...
		if(tipoRegistro.indexOf("VEH")>-1){
			constancia.append("RJB \n");
			constancia.append("- REGISTRO DE PROPIEDAD VEHICULAR \n");
			constancia.append("TITULOS PENDIENTES \n");
		...
		if(tipoRegistro.indexOf("EMB")>-1){
			constancia.append("- REGISTRO DE EMBARCACIONES PESQUERAS \n");
			constancia.append("TITULOS PENDIENTES \n");
		...
		if(tipoRegistro.indexOf("BUQ")>-1){
			constancia.append("- REGISTRO DE BUQUES \n");
			constancia.append("TITULOS PENDIENTES \n");
		...
		if(tipoRegistro.indexOf("AER")>-1){
			constancia.append("- REGISTRO DE AERONAVES \n");
			constancia.append("TITULOS PENDIENTES \n");
		...
		if(tipoRegistro.indexOf("PEJ")>-1){	
			constancia.append("- PARTICIPACIONES - REGISTRO DE PERSONAS JURÍDICAS \n");
			constancia.append("TITULOS PENDIENTES \n");
