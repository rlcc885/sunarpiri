...
<TITLE>
	   <logic:present name="Certificado" scope="request">	
          <logic:equal name="Certificado" property="tpo_certificado" value="G">Certificado de Gravamen</logic:equal> 	
	   </logic:present> 	  
</TITLE>
...
<logic:present name="Certificado" scope="request">	
	<table>
        ...
        <TR>
            ...
            <TD colspan="2" align="center">
            	...
            	<span class="cabeceraCertificadoSubTitulo"><%=bundle.getString("msn.certificado.rmc.gravamen.constancia.titulo") %></span>
        ...
        <TR>
        	<TD colspan="3"><br><br>
	        	...
	        	<span class="cabeceraCertificadoDefinicion"><%=bundle.getString("msn.certificado.rmc.gravamen.constancia.asunto") %></span>
	        	<br><br>
        		<p align="justify" class="cabeceraCertificadoComunDef">
        		<%=bundle.getString("msn.certificado.rmc.gravamen.constancia.contenido1") %> <u>
        		<logic:present name="objetoSolicitud">
        		 ...
        		 &nbsp; <%=bundle.getString("msn.certificado.rmc.gravamen.constancia.contenido2") %><br> 
        		</p>
        	</TD>
        </TR>
        <br>
	...
	<table>	
		<tr>
			<td colspan="3"><div align="justify" class="cabeceraCertificadoComunDef">
				<%=bundle.getString("msn.certificado.rmc.gravamen.constancia.contenido3") %><bean:write name="Certificado" property="ofic_reg_id_verif" scope="request"/><%=bundle.getString("msn.certificado.rmc.gravamen.constancia.contenido4") %>
				<%=horaSD%> <%=bundle.getString("msn.certificado.rmc.gravamen.constancia.contenido5") %> <bean:write name="Certificado" property="dia" scope="request"/>
	...
	<table>	
		<tr>
			<td colspan="3"><div align="justify" class="cabeceraCertificadoComunDef">
			<%=bundle.getString("msn.certificado.rmc.gravamen.constancia.baselegal") %> <BR><BR>
			<%=bundle.getString("msn.certificado.rmc.gravamen.constancia.pie1") %><br>
			<%=bundle.getString("msn.certificado.rmc.gravamen.constancia.pie2") %><br>			 
			</div></td>
		</tr>
	</table> 
<br><br>	
