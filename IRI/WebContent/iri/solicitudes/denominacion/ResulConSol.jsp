...
<% 
	...
	String url= request.getContextPath()+"/DenominacionPublicoIRI.do?state=consultaResumen&nuHoja="+ deno.getNumeroHoja() +"&anio=" +deno.getAnio()+ "&ofic="+ deno.getCoOficRegiPres()+ "&coRegi="+deno.getCoRegiPres();
%>
