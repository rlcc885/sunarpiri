							...
							alert("Ingrese su denominación o razón social en caso de modificar estatutos")
									...
									if(document.frm1.cboDepartamento.value=="00" ){
										...
										alert("Seleccione la provincia");	
											...
											document.frm1.action="<%=request.getContextPath()%>/DenominacionPublicoIRI.do?state=muestraForm2";		
											document.frm1.submit();
										}
									}
							}
...
function recuperaProvincia()
{
	...
	ajax.open( "GET", "<%=request.getContextPath()%>/iri/solicitudes/denominacion/AjaxProvincias.jsp?cboDepartamento="+document.all.cboDepartamento.value, true );
	ajax.send( "" );
}
function alertaSA(){
...
<b><font color="#949400">SOLICITUDES <font size="1">&gt;&gt;</font></FONT><font
			color="#666666"> Solicitud de Inscripci&oacute;n <font size="1">&gt;&gt;</font>
		Reserva de Preferencia Registral
		&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;PASO
		1 DE 3 </FONT></b>
<a href="<%=request.getContextPath()%>/iri/solicitudes/denominacion/pdf/ConPrac.pdf" target="_blank" ><br>[Ver - Consejos]</a>
<form name="frm1" method="post">
<table class="punteadoTablaTop" class="tablasinestilo" width="100%">
	<tr>
		<th colspan="5" align="left"><b><font color="#949400">RESERVA DE NOMBRE DE PERSONA JURIDICA PARA
		(seleccionar el que corresponda)</font></b></th>
...
<td>&nbsp;</td>
	...
	<tr align="left">
		<th colspan="5"><b><font color="#949400">DENOMINACION o RAZON SOCIAL cuya
		reserva solicita</font></b></th>
	</tr>
	<tr>
...
<table>
	...
	<tr>
		<td>1.<input type="text" name="Raz1" style="width:210"
			onblur="sololet(this)"><font color="#949400">*</font></td>
	</tr>
	<tr>
...
<table>
	<tr>
		<th colspan="5" align="left"><b><font color="#949400">TIPO DE PERSONA JURIDICA</font></b></th>
	</tr>
	<tr>
		...
		</select><font color="#949400">*</font></td></tr>

</table>
<div id="divModificacion" style="display:none">
<table class="punteadoTablaTop" width="100%">
	<tr>
		<td colspan="5"><b><font color="#949400">NOMBRE DE LA PERSONA JURIDICA EN
		CASO DE MODIFICACION DE ESTATUTOS</font></b></td>
	</tr>
	<tr>
	<tr>
...
<table border="0">
	<tr>
		<th colspan="2" align="left"><b><font color="#949400">DOMICILIO DE LA PERSONA JURIDICA</font></b></th>
	</tr>
	<tr>
	<tr>
		...
		<td align="left">&nbsp;&nbsp;Provincia &nbsp; <span id="salida"></span> <font
			color="949400">*</font></td>
	</tr>
	<tr></tr>
	<tr>
		<td colspan="2" align="left">
			<input class="formbutton" type="button" onclick="javascript:cancelar();" value="Cancelar" onMouseOver="javascript:mensaje_status('Grabar Vehiculo');return true;"
			onmouseOut="javascript:mensaje_status(' ');return true;">
		
			<INPUT class="formbutton" value="Validar" type="button" onclick="javascript:validar();" onMouseOver="javascript:mensaje_status('Cancelar');return true;"	onmouseOut="javascript:mensaje_status(' ');return true;">
			</td>
	</tr>
</table>
</form>
<table  class="punteadoTablaTop" width="100%">
	<tr>
		<td><strong><font color="#949400">* Los datos son
...
<table>
	<tr>
		<td><font color="#949400"><strong>Estimado
