...
<body>
	<div id="maincontent">
		<div class="innertube">
			<b><font color="#949400">DATOS PERSONALES &gt;&gt;</font><font color="#666666">Edici&oacute;n de datos Personales</font></b>
			<form name="frm1" method="POST">
			<input type="hidden" value="<%=perfilIdUsuario%>" name="hidPerfilUsuario">
			
			<table cellspacing=0>
		      <tr> 
		    	<td width="685" colspan="8" ><p align="left"><strong><font color="#949400" size="2">DATOS DEL USUARIO</font></strong></p></td>
		      </tr>
			</table>
			...
			<table cellspacing=0>
		      <tr> 
		    	<td width="685" colspan="8" ><p align="left"><strong><font color="#949400" size="2">DATOS DE LA CUENTA</font></strong></p></td>
		      </tr>
			</table> 
			<table class="punteadoTablaTop" width="600px">
			  <tr>
			    <td width="122">USUARIO ID</td>
			    <td width="187"><input type="text" name="userId" size="11" style="width:133" onblur="solonumlet(this)" disabled="true"></td>
			    <td width="140">&nbsp;</td>
			    <td>&nbsp;</td>
			  </tr>
			  <tr>
			    <td width="122">CONTRASE&Ntilde;A ACTUAL</td>
			  ...
			  <tr>
			    <td width="122">NUEVA CONTRASE&Ntilde;A</td>
			...
			<%   }  %>
			  ...
			  <tr>
			    <td width="122">PREGUNTA SECRETA</td>
			    <td width="187">
			...
			<%if (perfilIdUsuario == Constantes.PERFIL_ADMIN_ORG_EXT ||perfilIdUsuario ==  Constantes.PERFIL_AFILIADO_EXTERNO || perfilIdUsuario == Constantes.PERFIL_ADMIN_GENERAL || perfilIdUsuario == Constantes.PERFIL_INDIVIDUAL_EXTERNO) {%>
			   <tr>
			    <td width="122">CADUCIDAD DE CONTRASEÑA</td>
			    <td width="187">
			  ...
			  <tr><td  colspan="4"><a class="linkInicio" href="javascript:baja()">Presione aqu&iacute; si desea dar de baja la cuenta de nuestro servicio </a></td>
			  </tr>
			  <%}%>
			  ...
			  <tr>
			    <td align="center" colspan=4>
			      <input type="button" class="formbutton" onclick="javascript:doAceptar()" value="Aceptar"/>
			      <input type="button" class="formbutton" onclick="javascript:doCancelar()" value="Cancelar"/>
				</td>
			  </tr>
