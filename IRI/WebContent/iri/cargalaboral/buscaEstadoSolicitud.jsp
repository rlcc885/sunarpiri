...
{	
  ...
  <%}%>
	document.frm1.action="<%=request.getContextPath()%>/BusquedaSolicitudIRI.do?state=muestraEstadoSolicitud&pagina=1&tamano=1";
...
function DetalleSolicitud(sol_id, Registrador)
	{
		...
		document.frm1.action="<%=request.getContextPath()%>/CargaLaboralIRI.do?state=detalleSolicitud&registrador="+Registrador;
		document.frm1.submit();
...
function ShowReport(pagina){	
		...
		document.frm1.action="<%=request.getContextPath()%>/BusquedaSolicitudIRI.do?state=muestraEstadoSolicitud&pagina="+pagina;
		document.frm1.submit();
...
<table class=titulo cellspacing=0>
  <tr> 
      <td><b><font color="#949400">Servicios&gt;&gt; </font><font color="#666666">Estado de Solicitud</font></b></td>
	</tr>
</table>
<br>
  

<table class="punteadoTabla" cellspacing=0 width="600px">
  <tr>
      <td><font color="#949400"><strong>1. DATOS DE LA SOLICITUD</strong></font></td>
  </tr>
</table>
  ...
  <table  cellspacing=0 class="punteadoTabla" width="600px">
        ...
        <TR>
            ...
            onclick="javascript:BuscarSolicitud();"
            onmouseover="javascript:mensaje_status('Buscar solicitud');return true;" onmouseout="javascript:mensaje_status(' ');return true;"
            />
            </TD>
        </TR>
	...
	<!-- inicio: jrosas 31-08-07 -->
 	<logic:present name="arrResultado" scope="request">
	    <table class=grilla border="1">
	      <tr bgcolor="#949400"> 
	        <th width="23"><font color="#ffffff">No.</font></th>
	        <th width="133"><font color="#ffffff">Tipo de Certificado</font></th>
	        <th colspan="2"><font color="#ffffff">Objeto del Certificado</font></th>
	        <th width="57"><font color="#ffffff">Solicitante</font></th>
	        <th width="57"><font color="#ffffff">Ofic.Reg.</font></th>
	        <th width="94"><font color="#ffffff">Estado</font></th>
	        <th width="43"><font color="#ffffff">Ver Detalle</font></th>
			...
			<logic:iterate name="arrResultado" id="ResultBusq" scope="request">
				...
				<IMG src="images/lupa.gif" border="0"></a></center></td>	
				</tr>  
			</logic:iterate>
		 </table>
	     <br>
