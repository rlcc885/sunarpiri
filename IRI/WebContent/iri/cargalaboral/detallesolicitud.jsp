...
var cont2=0;
	...
	function BuscarSol(ApePat, ApeMat, Nombre, ofic_reg_desc){
			...
			//document.frm1.action="<%=request.getContextPath()%>/BuscaPartidasXIndices.do?state=buscarPersonaNatural";
			window.open("<%=request.getContextPath()%>/BuscaPartidasXIndices.do?state=buscarPersonaNatural&area1ApePat="+ApePat+"&area1ApeMat="+ApeMat+"&area1Nombre="+Nombre+"&ofic_reg_desc="+ofic_reg_desc+"&area1Razon='23000'& hid2= '1' & area1Siglas='MAS' ,fullscreen=no,toolbar=no,status=yes,menubar=no,scrollbars=yes,resizable=yes,directories=no,location=no");
...
function busqdirectapornumero(){
	...
	document.frm1.action = "<%=request.getContextPath()%>/BusquedaTitulo.do?state=buscarXNroTituloG";
	doSendChildren();
...
function PorPresentante(tipo){
	...
	document.frm1.method = "POST";
	document.frm1.action = "<%=request.getContextPath()%>/BusquedaTitulo.do?state=buscarXPresentantePNG&tipob=" + tipo;
	doSendChildren();	
	document.frm1.submit();
}
...
function PorPresentanteJ(tipo){
	...
	document.frm1.method = "POST";
	document.frm1.action = "<%=request.getContextPath()%>/BusquedaTitulo.do?state=buscarXPresentantePJG&tipob=" + tipo;
	doSendChildren();	
	document.frm1.submit();
}
...
function PorParticipante(tipo){
	...
	document.frm1.method = "POST";
	document.frm1.action = "<%=request.getContextPath()%>/BusquedaTitulo.do?state=buscarXParticipantePNG&tipob=" + tipo;
	doSendChildren();
	document.frm1.submit();
}
...
function PorParticipanteJ(tipo){
	...
	document.frm1.method = "POST";
	document.frm1.action = "<%=request.getContextPath()%>/BusquedaTitulo.do?state=buscarXParticipantePJG&tipob=" + tipo;
	doSendChildren();
	document.frm1.submit();
}
...
if (param1 == 1)
{
	if (param2==1)
	{
		document.frm2.action="<%=request.getContextPath()%>/BuscaPartidasXIndices.do?state=buscarPersonaNatural";
	}
	if (param2==2)
	{
		document.frm2.action="<%=request.getContextPath()%>/BuscaPartidasXIndices.do?state=buscarPersonaJuridica";
	}
}
if (param1 == 2)
{
	...
	if (param2==3)
	{
		document.frm2.action="<%=request.getContextPath()%>/BuscaPartidasXIndices.do?state=buscarRazonSocial";
	}
}
if (param1 == 3)
{
	...
	if (param2==3)
	{	
		document.frm2.action="<%=request.getContextPath()%>/BuscaPartidasXIndices.do?state=buscarPredio";
	}
	if (param2==41)
	{
		document.frm2.action="<%=request.getContextPath()%>/BuscaPartidasXIndices.do?state=buscarMineria";
	}
	if (param2==51)
	{
		document.frm2.action="<%=request.getContextPath()%>/BuscaPartidasXIndices.do?state=buscarEmbarcacion";
	}
	if (param2==61)
	{
		document.frm2.action="<%=request.getContextPath()%>/BuscaPartidasXIndices.do?state=buscarBuque";
	}		
	if (param2==7)
	{
		document.frm2.action="<%=request.getContextPath()%>/BuscaPartidasXIndices.do?state=buscarAeronaveXMatricula";
	}
	if (param2==8)
	{
		document.frm2.action="<%=request.getContextPath()%>/BuscaPartidasXIndices.do?state=buscarAeronaveXNombre";
	}
	if (param2==9)
	{
		document.frm2.action="<%=request.getContextPath()%>/BuscaPartidasXIndices.do?state=buscarAeronaveXRazonSocial";
	}
}
if (param1 == 4)
{
	if (param2==1)
	{
		document.frm2.action="<%=request.getContextPath()%>/BuscaPartidasXIndices.do?state=buscarXNombreVehicular&tipo=1";
	}
	if (param2==2)
	{
		document.frm2.action="<%=request.getContextPath()%>/BuscaPartidasXIndices.do?state=buscarXNombreVehicularJuri&tipo=2";
	}
	if (param2==3)
	{
		document.frm2.action="<%=request.getContextPath()%>/BuscaPartidasXIndices.do?state=buscarXNombreVehicularMotor&tipo=2";
	}
	if (param2==4)
	{
		document.frm2.action="<%=request.getContextPath()%>/BuscaPartidasXIndices.do?state=buscarXNombreVehicularChasis&tipo=2";
	}
}
...
if(param1 == 5)
{
	if(param2==1)
	{
		...
		document.frm2.action="<%=request.getContextPath()%>/Publicidad.do?state=buscarXPlaca&tipo=1";
	}
	if(param2==2)
	{
		...
		if(partida!=null && partida!="")
		{
			...
			document.frm2.action="<%=request.getContextPath()%>/Publicidad.do?state=buscarXNroPartida&tipo=1";
		}else if(matricula!=null && matricula!="")
		{
			document.frm2.area3EmbarcacionNumeroMatricula.value = matricula;
			document.frm2.action="<%=request.getContextPath()%>/BuscaPartidasXIndices.do?state=buscarEmbarcacion&tipo=1";
		}
	}
	if(param2==3)
	{
		...
		{
			document.frm2.area3EmbarcacionNumeroMatricula.value = matricula;
			document.frm2.action="<%=request.getContextPath()%>/BuscaPartidasXIndices.do?state=buscarBuque&tipo=1";
		}
	}
	if(param2==4)
	{
		...
		{
			document.frm2.area3EmbarcacionNumeroMatricula.value = matricula;
			document.frm2.action="<%=request.getContextPath()%>/BuscaPartidasXIndices.do?state=buscarAeronaveXMatricula&tipo=1";
		}
		else if(serie!=null && serie!="")
		{
			...
			document.frm2.action="<%=request.getContextPath()%>/BuscaPartidasXIndices.do?state=buscarBienesSigc";
		}
	}
}if(param1==6)
{
	if(param2==1)
	{
		document.frm2.action="<%=request.getContextPath()%>/Publicidad.do?state=buscarXTomoFolio&tipo=1";
	}
	if(param2==2)
	{
		document.frm2.txt1.value = document.frm2.numeroFicha.value;
		document.frm2.action="<%=request.getContextPath()%>/Publicidad.do?state=buscarXFicha&tipo=1";
	}
	if(param2==3)
	{
		document.frm2.action="<%=request.getContextPath()%>/Publicidad.do?state=buscarXPlaca&tipo=1";
...
if (param1 == 7)
{
	...
	{	
		...
		document.frm2.action="<%=request.getContextPath()%>/BuscaPartidasXIndices.do?state=buscarPersonaNaturalSigc";
	}
	if (param2==2)
	{
	    document.frm2.tipo.value="J";
		document.frm2.action="<%=request.getContextPath()%>/BuscaPartidasXIndices.do?state=buscarPersonaJuridicaSigc";
	}
...
if (param1 == 8)
{
	...
	{	
		document.frm2.tipo.value="B";
	   	document.frm2.action="<%=request.getContextPath()%>/BuscaPartidasXIndices.do?state=buscarBienesRmc";
	}
...
if (param1 == 9)
{
	...
	{	
	    document.frm2.tipo.value="N";
		document.frm2.action="<%=request.getContextPath()%>/BuscaPartidasXIndices.do?state=buscarPersonaNaturalRmc";
	}
	if (param2==2)
	{
	    document.frm2.tipo.value="J";
		document.frm2.action="<%=request.getContextPath()%>/BuscaPartidasXIndices.do?state=buscarPersonaJuridicaRmc";
	}
	if (param2==3)
	{
	    document.frm2.tipo.value="D";
		document.frm2.action="<%=request.getContextPath()%>/BuscaPartidasXIndices.do?state=buscarTipoNumeroDocumentoRmc";
	}
...
function CertificadoPorVerificar(){
	   ...
	   <logic:iterate name="Solicitud" property="objetoSolicitudLista" id="objsol2" scope="request">	
			<logic:equal name="objsol2" property="certificado_id" value="18">
				...
				constancia = "";			
				window.open("<%=request.getContextPath()%>/CargaLaboral.do?state=verCertificadosNegativo&Tipo_Cert="+tipocert+"&sol_id="+solid+"&EstadoCertificado='C'&Constancia="+constancia,"Certificado",'fullscreen=no,toolbar=no,status=yes,menubar=no,scrollbars=yes,resizable=no,directories=no,location=no,directories=no,width=719,height=850');		
			</logic:equal>
			<logic:notEqual name="objsol2" property="certificado_id" value="18">				
				solid = document.frm1.sol_id.value;
				constancia = document.frm1.Constancia.value;
				window.open("<%=request.getContextPath()%>/CargaLaboral.do?state=verCertificadosNegativo&Tipo_Cert="+tipocert+"&sol_id="+solid+"&EstadoCertificado='C'&Constancia="+constancia,"Certificado",'fullscreen=no,toolbar=no,status=yes,menubar=no,scrollbars=yes,resizable=no,directories=no,location=no,directories=no,width=719,height=880');
			</logic:notEqual>
		</logic:iterate>
...
function CertificadoPorExpedir(){
		...
		//window.open("<%=request.getContextPath()%>/CargaLaboral.do?state=verCertificadosNegativo&Tipo_Cert="+tipocert+"&sol_id="+solid+"&EstadoCertificado='V'","Certificado",'fullscreen=no,toolbar=no,status=yes,menubar=no,scrollbars=no,resizable=no,directories=no,location=no,directories=no,width=719,height=997');
		window.open("<%=request.getContextPath()%>/CargaLaboral.do?state=verCertificadosNegativo&Tipo_Cert="+tipocert+"&sol_id="+solid+"&EstadoCertificado=V","Certificado",'fullscreen=no,toolbar=no,status=yes,menubar=no,scrollbars=yes,resizable=no,directories=no,location=no,directories=no,width=719,height=880');
...
///-->
		...
		doyou = true;  		
  		...
  		if(doyou == true) {
			document.frm1.action="<%=request.getContextPath()%>/CargaLaboral.do?state=certificadoVerficado";
			document.frm1.submit();
		}	
}
...
function GuardarCertExpedido()
{
		...
		//Fin:mgarate
  		...
  		if(doyou == true) {
			document.frm1.action="<%=request.getContextPath()%>/CargaLaboral.do?state=certificadoExpedido";
			document.frm1.submit();
		}
}
function devolucion(){
		document.frm1.action="<%=request.getContextPath()%>/Devolucion.do?state=muestraModoDevolucion";
		document.frm1.submit();
}
function VerPartida(refnum_Part,accion)
{
	obj_sol_id = document.frm1.objeto_Sol_Id.value;	
ventana=window.open('<%=request.getContextPath()%>/Publicidad.do?state=visualizaPartida&objetoId='+obj_sol_id+'&accion=' + accion +'&noSolicitud=' + <bean:write name="Solicitud" property="solicitud_id" scope="request"/> + '&refnum_part=' + refnum_Part,'1024x768','toolbar=no,status=yes,scrollbars=yes,resizable=yes,location=no,menubar=no,directories=no,width=950,height=650, top=0, left=0')
//ventana=window.open('<%=request.getContextPath()%>/Publicidad.do?state=visualizaPartida&objetoId='+obj_sol_id+'&accion=' + accion + '&refnum_part=' + refnum_Part,'1024x768','toolbar=no,status=yes,scrollbars=yes,resizable=yes,location=no,menubar=no,directories=no,width=950,height=650, top=0, left=0')
//	ventana=window.open('<%=request.getContextPath()%>/Publicidad.do?state=visualizaPartida&objetoId='+obj_sol_id+'&accion=' + accion <%--<logic:present name="Solicitud" property="solicitud_id" scope="request">+'&noSolicitud=' + <bean:write name="Solicitud" property="solicitud_id" scope="request"/></logic:present>--%> + '&refnum_part=' + refnum_Part,'1024x768','toolbar=no,status=yes,scrollbars=yes,resizable=yes,location=no,menubar=no,directories=no,width=950,height=650, top=0, left=0')
...
<table class=titulo cellspacing=0>
  <tr> 
      <td><b><font color="#949400">REGISTRADOR &gt;&gt; CARGA REGISTRAL &gt;&gt;</font> 
        <font color="#666666">Detalle de la Solicitud></font></b></td>
	</tr>
</table>
<br>
<table class=cabeceraformulario cellspacing=0 width="100%">
  <tr>
      <td><font color="#949400"><strong> DATOS BASICOS DE LA SOLICITUD</strong></font></td>
  </tr>
</table>
<table class="punteadoTabla" cellspacing=0 width="100%">
	    ...
	    <tr> 
		  ...
		  <logic:present name="devolucion">
			 <logic:equal name="devolucion"  value="true">
				<a href="javascript:devolucion();"><img src="<%=request.getContextPath()%>/images/btn_solicitar_devolucion.gif"></a>
			 </logic:equal>
        ...
        <tr>    
		    ...
		    <td >
		    <%if(flagInter) {%>
	 	    &nbsp;<strong><font color="#949400">
	 	    <bean:write name="Solicitud" property="estado_descripcion" scope="request"/></font></strong> 
	        <%} else {%>
	        
	        	<logic:present name="certificado">
	        		<logic:equal name="certificado" property="flagPagoCrem" value="0">
						<strong><font color="#949400">Liquidado</font></strong>
					...
					<logic:equal name="certificado" property="flagPagoCrem" value="1">
						<strong><font color="#949400"><bean:write name="Solicitud" property="estado_ext_descripcion" scope="request"/></font></strong>
					</logic:equal>
	        	</logic:present>
	        ...
	        <logic:equal name="Solicitud" property="estado" value="<%= Constantes.ESTADO_SOL_DESPACHADA%>">
	        	<logic:present name="Solicitud" parameter="destinatarioBean" scope="request" >	      		
					<logic:equal name="Solicitud" property="destinatarioBean.tpo_env" value="V">
							Puede apersonarse a ventanilla a recoger su certificado registral.
					</logic:equal>
				</logic:present>         
			</logic:equal>&nbsp;
			</td>	
		        ...
		        <logic:equal name="objsol8" property="tpo_cert" value="L">  
		          <tr>                   		
		        	<td>&nbsp;</td>
			       	...
			       	<td>
			       	<bean:write name="objsol8" property="refnum_part"/>
			       	</td>        
			       	<logic:equal name="objsol8" property="certificado_id" value="8">
			       		<td width="163"><strong>NRO PAGINAS:</strong></td>
			       		<td>
			       	<bean:write name="objsol8" property="numpag"/>
			       	   </td>
			       	</logic:equal>
			       	<logic:notEqual name="objsol8" property="certificado_id" value="8">
			       	<td>&nbsp;</td><td>&nbsp;</td>
			       	</logic:notEqual>
				...
				<logic:iterate name="Solicitud" property="objetoSolicitudLista" id="objsol22" scope="request">		
				  		 ...
				  		 <tr>
							...
							<td colspan="4"><strong>
								<logic:equal name="Solicitud" property="tpo_cert_neg" value="G">
									Certificado Compendioso de Gravámen
								</logic:equal>
			        ...
			        <logic:equal name="objsol22" property="tpo_cert" value="D">                     		
				  		 <tr>
							...
							presione aqui
							<A href="javascript:CertificadoPorExpedir();"><img src="images/lupa.gif" border="0" onmouseover="javascript:mensaje_status('Visualizar Certificado');return true;" onmouseOut="javascript:mensaje_status(' ');return true;"></A>
				...
				<logic:equal name="objsol25" property="tpo_cert" value="C">                     		
			  		 <tr>
						...
						<input type="hidden" name="tip_cert" value="<bean:write name="Solicitud" property="tpo_cert_neg" scope="request"/>">
							...
							<logic:equal name="Solicitud" property="tpo_cert_neg" value="H">
								Certificado Registral Histórico
							</logic:equal>	
							<logic:equal name="Solicitud" property="tpo_cert_neg" value="C">
							Certificado Registral Condicionado
							</logic:equal>	
				  		</logic:present></strong>				
		<A href="javascript:CertificadoPorExpedir();">Impresión:</A></td>															
					</tr>	
...
<%}%>
 <!-- Datos del Solicitante que se mostraran para usuarios Internos--> 
	...
	<table class="punteadoTabla" cellspacing=0 width="100%">
	  <tr>
	      <td><font color="#949400"><strong>1. DATOS DEL SOLICITANTE</strong></font></td>
	  </tr>
	</table>
	<table class="punteadoTabla" cellspacing=0 width="100%">
	   <tr> 
  ...
  <table class="punteadoTabla" cellspacing=0 width="100%">
  	<tr>
   		 <td><font color="#949400"><strong>2. DATOS DEL DESTINATARIO</strong></font></td>
  	</tr>
   </table>
   <table class="punteadoTabla" cellspacing=0 width="100%">
	    <tr> 
	...
	<table class="punteadoTabla" cellspacing=0 width="100%">
	  <tr>
    	  <td><font color="#949400"><strong>3. DATOS DEL PAGO</strong></font></td>
	  </tr>
	</table>
	<table class="punteadoTabla" cellspacing=0 width="100%">
	    <tr> 
	...
	<table class="punteadoTabla" width="100%">
	  <tr>
	   ...
	   />
	    ...
	    onmouseover="javascript:mensaje_status('Regresar');return true;" onmouseOut="javascript:mensaje_status(' ');"
	   />
