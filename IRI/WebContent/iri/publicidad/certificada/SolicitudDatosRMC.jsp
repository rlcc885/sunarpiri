...
<script Language="javascript">
	...
	function validar(val){
		...
		document.frm2.action="/iri/CertificadosIRI.do?state=guardarDatosBasicos";
		...
		document.frm3.action="/iri/CertificadosIRI.do?state=guardarDatosBasicos";
	...
	<div id="maincontent">
		...
		<table class="punteadoTablaTop" width="600">
			...
			<tr>
				...
				<td>
					<select name="cboTipoCert" size="1" disabled="disabled">
		...
		<form name="frm1" method="post">
			...
			<table cellspacing=0>
		      <tr> 
		    	<td width="685" colspan="8" >
		    		<p align="left"><font color="#949400" size="2"><strong>Persona Natural</strong></font></p>
		    	</td>
		      </tr>
			</table>
			...
			<table class="punteadoTablaTop" width="600">
				...
				<table width="100%">
				<tr>
					<td width="130">Tipo Participante:</td>
					<td>
			...
			<table cellspacing=0 border="0">
				<tr>
					<td colspan="3" align="center">
						<input type="button" class="formbutton" value="Solicitar" onclick="javascript:validar(1);" 
		...
		<form name="frm2" method="post">
			...
			<table cellspacing=0>
		      <tr> 
		    	<td width="685" colspan="8" >
		    		<p align="left"><font color="#949400" size="2"><strong>Persona Jurídica</strong></font></p>
		    	</td>
		      </tr>
			</table>
			...
			<table cellspacing=0 border="0">
				<tr>
					<td colspan="3" align="center">
						<input type="button" class="formbutton" value="Solicitar" onclick="javascript:validar(2);" 
		...
		<form name="frm3" method="post">
			...
			<table cellspacing=0>
		      <tr> 
		    	<td width="685" colspan="8" >
		    		<p align="left"><font color="#949400" size="2"><strong>Tipo y Número de documento</strong></font></p>
		    	</td>
		      </tr>
			</table>
			...
			<table class="punteadoTablaTop" width="600">
				...
				<tr>
					...
					<td>
						<input type="text" name="txtNumeroDocumento" maxlength="15">
					</td>
				</tr>
			...
			<table cellspacing=0 border="0">
				<tr>
					<td colspan="3" align="center">
						<input type="button" class="formbutton" value="Solicitar" onclick="javascript:validar(3);" 
						onmouseover="javascript:mensaje_status('Buscar por Tipo y Numero de Documento');return true;"
						onmouseOut="javascript:mensaje_status(' ');return true;"/>
					</td>
				</tr>
			</table>
