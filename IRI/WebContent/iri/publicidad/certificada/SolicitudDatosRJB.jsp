		...
		<div class="innertube">
			...
			<form name="frm1" method="post">
				<table>
					<tr>
						<td>
							<strong><font color="#949400" size="2">1. DATOS DEL SOLICITANTE</font></strong>
						</td>
					</tr>
				</table>
				...
				<table class="punteadoTablaTop" width="600px">
					...
					<tr>
						<td width="110">Oficina Registral</td>
						<td>
							...
							<logic:greaterEqual name="item22" property="codigo" value="25">
								<logic:lessEqual name="item22" property="codigo" value="28">
									...
									<tr>
										...
										<td><input type="radio" name="radTipInfoDominio" checked="checked"  value="C" >Completa
											<input type="radio" name="radTipInfoDominio" value="U">Último Propietario
										</td>
					...
					<table width="100%">
						<tr>
							<td>Buscar por:</td>	
							<td colspan="2">
								<input type="radio" name="radBusca" checked="checked" value="Placa">Placa
								<input type="radio" name="radBusca">Partida
							</td>
						</tr>
						<tr>
							<td>Número</td>	
							<td>
								<input type="text" name="txtNumero" maxlength="8" onblur="mayuscula(this)">
							</td>
						</tr>
						</table>
					</div>
				...
				<table cellspacing=0 border="0">
					<tr>
						<td>
							<input type="button" class="formbutton"	value="Buscar" onclick="javascript:validar();" 
								onmouseover="javascript:mensaje_status(' ');return true;" onmouseOut="javascript:mensaje_status(' ');return true;"/>
						<td>&nbsp;</td>			
					</tr>
				</table>
		</form>
