...
<%}%>
	...
	%> 
	 var p = confirm("La partida asociada no se encuentra en estado ACTIVA. Esta seguro que desea realizar la solicitud?")
		if(p==true){
			document.frm1.action="/iri/CertificadosIRI.do?state=guardarDatosComplementarios";
			document.frm1.submit();
		}
...
<BODY onLoad="javascript:gEnvio('1');">
	<div id="maincontent">
		<div class="innertube">
			<form name="frm1" method="post">
		        ...
		        <%}else if(request.getAttribute("hidTipo") != null && request.getAttribute("hidTipo").equals(Constantes.CERTIFICADO_BUSQUEDA)){%>
		        	<b><font color="#949400">SERVICIOS &gt;&gt;</font><font color="#666666">Solicitud de Certificados de Busqueda</b>
		        <%}else{%>
		        	<b><font color="#949400">SERVICIOS &gt;&gt;</font><font color="#666666">Solicitud de Copia Literal</b>
		        <%} %>
				<br>
				<table width="600px">
					<tr> 
				      <td align="center" vAlign="center" colspan="3">  
					  	<div style="background-color: #666666 width: 430px; border-width: 1px; border-color: 000000; border-style: solid;">	
		...
		<table cellspacing=0>
		  <tr > 
			<td><strong><font color="#949400" size="2">1. DATOS DEL SOLICITANTE</strong></td>
		  </tr>
		</table>
	  	<table class="punteadoTablaTop" width="600">
			<tr> 
		      <td width="150">TIPO DE PERSONA</td>
      ...
      <div id="areaSoliNatu" style="visibility:visible;display:">
      	<table border="0" class="punteadoTablaOnlyBottom" width="600">
			<tr>
				<td width="150">
					APELLIDOS Y NOMBRES<br>De quien realiza la solicitud
				</td>
				<td>
					<table border="0">
						<tr>
      ...
      <div id="areaSoliJuri" style="visibility:hidden;display:none">  
        <table class="punteadoTabla" width="600">
          <tr> 
            <td width="150">RAZON SOCIAL<br>De quien realiza la solicitud</td>
	...
	<table cellspacing=0>
      <tr> 
    	<td width="685" colspan="8" >
    		<p align="left"><font color="#949400" size="2"><strong>2. DATOS DEL ENVIO</strong></font></p>
    	</td>
      </tr>
	</table>
  <table class="punteadoTablaTop" width="600px">	
  <tr>
      <td width="150">FORMA DE ENVIO</td>
      <td width="130"> 
	  ...
	  <td width="140"> 
		...
		Recojo en Ventanilla
	  </td>
	  <td width="150">&nbsp; </td>
  </tr>
  </table>
		<div id="areaDomi" style="visibility:hidden;display:none">
			<table cellspacing=0 class="punteadoTabla" width="600">
			  <tr>
			  ...
			  <tr>
				  ...
				  <td width="150"><input name="txtEnvCodPost" type="text" onBlur="sololet(this)"></td>
					...
					<table cellspacing=0 class="punteadoTabla" width="600">
					  <tr>
					      <td width="150">&nbsp;OFICINA REGISTRAL</td>
					      <td width="180">
					      	&nbsp; 
  		...
  		<table class="punteadoTabla" width="600">
			<tr> 
		      <td width="150">TIPO DE PERSONA</td>
		      <td width="130"> <input type="radio" name="radEnvTipoPer" value="N" onClick="javascript:gDest('1');" checked>
		        Persona Natural
		      </td>
		      <td width="140"> 
		      	<input type="radio" name="radEnvTipoPer" value="J" onClick="javascript:gDest(0);">Persona Jur&iacute;dica
		      </td>
		      <td width="150">&nbsp;</td>
	    	</tr>
	    </table>
  ...
  <table>
    <div id="areaDestNatu" style="visibility:visible;display:">
      <table class="punteadoTablaOnlyBottom" width="600">
        <tr>
            <td width="150">APELLIDOS Y NOMBRES<br>De quien recibirá la solicitud</td>
            <td width="130"> 
    ...
    <div id="areaDestJuri" style="visibility:hidden;display:none">  
      <table class="punteadoTabla" width="600">
        <tr>
          <td>&nbsp;</td>
            <td width="150">RAZON SOCIAL<br>De quien recibirá la solicitud</td>
	...
	<table cellspacing=0>
      <tr> 
    	<td width="685" colspan="8" >
    		<p align="left"><font color="#949400" size="2"><strong>3. DATOS DEL PAGO</strong></font></p>
    	</td>
      </tr>
	</table>
  <table class="punteadoTablaTop" width="600px">
    ...
    <tr> 
      <td width="5">&nbsp;</td>
      <td width="300">COSTO DEL SERVICIO</td>
    ...
    <tr> 
      <td>&nbsp;</td>
      <td width="300">MENSAJERÍA REGISTRAL (en caso de env&iacute;o a domicilio)</td>
      <td width="280" align="center">
  ...
  <table class=formulario cellspacing=0>
    ...
    <tr> 
      ...
      <td width="130"> <input type="radio" name="tipopago" value="<%=Constantes.PAGO_LINEA_PREPAGO%>" onClick="javascript:invisible_navegador(navegador,'area3','narea3','i');" checked> 
        EN LINEA CON MI SALDO DISPONIBLE</td>
      <td width="130"> 
        <div align="center">
        	<input type="button" class="formbutton" value="Pagar" onclick="javascript:Validar();" onmouseover="javascript:mensaje_status('Pagar');return true;" onmouseOut="javascript:mensaje_status(' ');return true;"/>
        </div>
      </td>
    </tr>
    <tr> 
...
<table class="punteadoTabla" width="600px">
  <tr>
    <td width="20%" colspan="2">TIPO DE PAGO</td>
    <td width="20%" colspan="2"><input type="radio" value="E|Efectivo" name="tipopago" checked onClick="ShowCheques(this.value)">Efectivo&nbsp; <input type="radio" value="C|Cheque" name="tipopago" onClick="ShowCheques(this.value)">Cheque&nbsp;</td>
    <td width="20%" colspan="2"><p align="left">&nbsp;</p></td>
...
<table class="punteadoTabla" width="600px">
  ...
  <tr>
    <td width="19%">NUMERO DE CHEQUE</td>
...
<table width="600px">
  <tr>
	...
	<td width="50%" align="right">
	  <div id="HOJA3">	
	    <input type="button" class="formbutton" value="Regresar" onclick="javascript:history.back();" onmouseover="javascript:mensaje_status('Regresar');return true;" onmouseOut="javascript:mensaje_status(' ');return true;"/>
	  </div>
	</td>
  </tr>
</table>
