...
<BODY onLoad="javascript:gEnvio('1');">
    ...
    <tr> 
      ...
      <div id="areaSoliNatu" style="visibility:visible;display:">
        <table class="punteadoTabla" width="600px">
          <tr> 
            <td>&nbsp;</td>
            <td width="150">APELLIDOS Y NOMBRES<br>De quien realiza la solicitud</td>
            <td>
    ...
    <tr> 
      ...
      <td width="133">NUMERO DE DOCUMENTO</td>
...
<table class="punteadoTabla" width="600px">
  ...
  <tr>
    <td width="20%" height="11" colspan="2">TIPO DE PAGO</td>
