...
<link rel="stylesheet" type="text/css"
	href="<%=request.getContextPath()%>/styles/iri.css">
...
<b><font color="#949400">SERVICIOS &gt;&gt;</font><font
	color="#666666">B&uacute;squeda de &Iacute;ndice de Partidas</b> <%-- Inicio:mgarate:29/05/2007 --%>
<input type="hidden" name="criterio" value="" /> <%-- Fin:mgarate:29/05/2007 --%>
<br>
<%-- inicio: jrosas 11-07-07--%> <layer id="narea14">
...
<table cellspacing=0>
	<tr>
		...
		<td align=center><input type="button" name="todos"
		...
		<td align=center><select name="listbox2" multiple size="10"
			style="width: 260px" width="260px" onDblClick="doRemove1()">
		</select></td>
	</tr>
</table>
</div>
</layer> <%-- fin: jrosas 11-07-07--%>
...
<table cellspacing=0>
	<tr>
		...
		<div id="area6" style="visibility: visible;"><a
			class="linkInicio"
			href="javascript:VentanaFlotante('/iri/acceso/mapas/MAPA1.htm')"
			onmouseover="javascript:mensaje_status('Identifique su Oficina Registral');return true;"
			onmouseOut="javascript:mensaje_status(' ');return true;">Identifique
		su Oficina Registral</a></div>
		</layer></td>
	</tr>
</table>
...
<table width="600px">
	<tr>
		<td align="center" vAlign="center"><layer id="narea5"
			visibility="hide">
		<div id="area5"
			style="visibility: hidden; background-color: white; width: 100%; border-width: 1px; border-color: 000000; border-style: solid">
...
<table width="600px">
	<tr>
		<td align="center" width="100%"><layer id="narea13"
			visibility="hide">
		<div id="area13"
			style="text-align:center;visibility: hidden; background-color: white; width: 100%; border-width: 1px; border-color: 000000; border-style: solid">
		B&uacute;squeda Nacional</div>
		</layer></td>
	</tr>
</table>
...
<table class="punteadoTablaTop" width="600px">
	<tr>
		<td align=left width="130">Area Registral <input type="hidden"
			name="comboArea"> <input type="hidden" name="hidAreaLibro">
		</td>
		<td><select name="comboAreaLibro" size="1"
		...
		<td align=center><font color="#949400"><b>Costo Por
		Búsqueda</b></font>&nbsp;<input type="text" name="costo" size="2" value="0"
			disabled="true"></td>
	</tr>
</table>
...
<layer id="narea1">
<div id="area1"
	style="position: absolute; left: < %=positionLeft% > px; top: < %=positionTop% > px; visibility: visible">
<table>
	<tr>
		<td><strong><font color="#949400" size="2">B&uacute;squeda
		Registro Personas Naturales por Participante</font></strong></td>
	</tr>
</table>
<table>
	<tr>
		<td><strong><font color="#949400" size="2">Buscar
		por Participante Persona Natural</font></strong></td>
	</tr>
</table>
<table class="punteadoTablaTop" width="600">
	<tr>
		<td width="130">Apellido Paterno</td>
		<td><input name="area1ApePat" style="width: 130" maxlength="30"
			onblur="sololet(this)"></td>
	</tr>
	<tr>
		<td width="130">Apellido Materno</td>
		<td><input name="area1ApeMat" style="width: 130" maxlength="30"
			onblur="sololet(this)"></td>
	</tr>
	<tr>
		<td width="130">Nombres</td>
		<td><input name="area1Nombre" style="width: 130" maxlength="40"
			onblur="sololet(this)"></td>
	</tr>
	<%if (flagInterno) { %>
	<tr>
		<td width="130"><input type="checkbox" name="checkInactivosPN3"
			checked> Incluir Inactivos</td>
		<td>&nbsp;</td>
	</tr>
	<%}%>
</table>
...
<table cellspacing=0 border="0">
	<tr>
		...
		<div id="ocultar1"><input type="button" class="formbutton"
			onclick="javascript:onclick=doBuscar(1,1)" value="Buscar" /></div>
		</td>
	</tr>
</table>
...
<table cellspacing=0>
	<tr>
		<td><strong><font color="#949400" size="2">Buscar
		por Participante Persona Jur&iacute;dica</font></strong></td>
	</tr>
</table>
<table class="punteadoTabla" width="600px">
	<tr>
		<td width="130">Raz&oacute;n Social</td>
		<td><input type="text" name="area1Razon" style="width: 130"
			maxlength="150" onblur="solonumlet(this)"></td>
	</tr>
	<tr>
		<td width="130">Siglas</td>
		<td><input type="text" name="area1Siglas" style="width: 130"
			maxlength="50" onblur="solonumlet(this)"></td>
	</tr>
	<%if (flagInterno) { %>
	<tr>
		<td width="130"><input type="checkbox" name="checkInactivosPJ3"
			checked> Incluir Inactivos</td>
		<td>&nbsp;</td>
	</tr>
	<%}%>
...
<table cellspacing=0 border="0">
	<tr>
		<td colspan="3" align="center">
		<div id="ocultar2"><input type="button" class="formbutton"
			onclick="javascript:onclick=doBuscar(1,2)" value="Buscar" /></div>
		</td>
	</tr>
</table>
...
<table>
	<tr>
		<td><strong><font color="#949400" size="2">B&uacute;squeda
		Registro Personas Jur&iacute;dicas por Participante </td>
	</tr>
</table>
<table>
	<tr>
		<td colspan=5><strong><font color="#949400" size="2">Buscar
		por Participante Persona Natural</font></strong></td>
	</tr>
</table>
<table class="punteadoTablaTop" width="600">
	<tr>
		<td width="130">Apellido Paterno</td>
		<td><input name="area2ApePat" style="width: 130" maxlength="30"
			onblur="sololet(this)"></td>
	</tr>
	<tr>
		<td width="130">Apellido Materno</td>
		<td><input name="area2ApeMat" style="width: 130" maxlength="30"
			onblur="sololet(this)"></td>
	</tr>
	<tr>
		<td width="130">Nombres</td>
		<td><input name="area2Nombre" style="width: 130" maxlength="40"
			onblur="sololet(this)"></td>
	</tr>
	<tr>
		<td width="130">&nbsp;</td>
	...
	<%if (flagInterno) { %>
	<tr>
		<td width="130"><input type="checkbox" name="checkInactivosPN2"
			checked> Incluir Inactivos</td>
		<td>&nbsp;</td>
	</tr>
	<%}%>
...
<table cellspacing=0 border="0">
	<tr>
		<td colspan="3" align="center">
		<div id="ocultar3"><input type="button" class="formbutton"
			onclick="javascript:onclick=doBuscar(2,1)" value="Buscar" /></div>
		</td>
	</tr>
</table>
<table>
	<tr>
		<td colspan=5><strong><font color="#949400" size="2">Buscar
		por Participante Persona Juridica</font></strong></td>
	</tr>
</table>
<table class="punteadoTablaTop" width="600px">
	<tr>
		<td width="130">Raz&oacute;n Social</td>
		<td><input type="text" name="area2Razon1" style="width: 130"
			maxlength="150" onblur="solonumlet(this)"></td>
	</tr>
	<tr>
		<td width="130">Siglas</td>
		<td><input type="text" name="area2Siglas" style="width: 130"
			maxlength="50" onblur="solonumlet(this)"></td>
	</tr>
	<%if (flagInterno) { %>
	<tr>
		<td width="130"><input type="checkbox" name="checkInactivosPJ2"
			checked> Incluir Inactivos</td>
		<td>&nbsp;</td>
	</tr>
	<%}%>
...
<table cellspacing=0 border="0">
	<tr>
		<td colspan="3" align="center">
		<div id="ocultar4"><input type="button" class="formbutton"
			onclick="javascript:onclick=doBuscar(2,2)" value="Buscar" /></div>
		</td>
	</tr>
</table>
<br>
<table>
	<tr>
		<td><strong><font color="#949400" size="2">B&uacute;squeda
		Registro Personas Jur&iacute;dicas por Raz&oacute;n Social</font></strong></td>
	</tr>
</table>
<table class=punteadoTablaTop width="600">
	<tr>
		<td width="130">Raz&oacute;n Social</td>
		<td><input type="text" name="area2Razon2" style="width: 130"
			maxlength="250" onblur="solonumlet(this)"></td>
	</tr>
	<tr>
		<td width="130">Siglas</td>
		<td><!--input type="hidden" name="area2SiglasB"--> <input
			type="text" name="area2SiglasB" style="width: 130" maxlength="50"
			onblur="solonumlet(this)"></td>
	</tr>
</table>
<table cellspacing=0 border="0">
	<tr>
		<td colspan="3" align="center">
		<div id="ocultar5"><input type="button" class="formbutton"
			onclick="javascript:onclick=doBuscar(2,3)" value="Buscar" />
		<div>
		</td>
	</tr>
</table>
...
<table>
	<tr>
		<td><strong><font color="#949400" size="2">B&uacute;squeda
		Registro de Propiedad Inmueble por Participante</font></strong></td>
	</tr>
</table>
<table class="punteadoTabla" width="600px">
	<tr>
		<td colspan=2><strong><font color="#949400" size="2">Buscar
		por Participante Persona Natural</font></strong></td>
	</tr>
	<tr>
		<td width="130">Apellido Paterno</td>
		<td><input type="text" name="area3ParticipanteApePat"
			style="width: 130" maxlength="30" onblur="sololet(this)"></td>
	</tr>
	<tr>
		<td width="130">Apellido Materno</td>
		<td><input type="text" name="area3ParticipanteApeMat"
			style="width: 130" maxlength="30" onblur="sololet(this)"></td>
	</tr>
	<tr>
		<td width="130">Nombres</td>
		<td><input type="text" name="area3ParticipanteNombre"
			style="width: 130" maxlength="40" onblur="sololet(this)"></td>
	</tr>
	<%if (flagInterno) { %>
	<tr>
		<td width="130"><input type="checkbox" name="checkInactivosPN1"
			checked> Incluir Inactivos</td>
		<td>&nbsp;</td>
	</tr>
	<%}%>
...
<table cellspacing=0 border="0">
	<tr>
		<td colspan="3" align="center">
		<div id="ocultar6"><input type="button" class="formbutton"
			onclick="javascript:onclick=doBuscar(3,1)" value="Buscar"
			onmouseover="javascript:mensaje_status('Busqueda de Registro de Propiedad Inmueble por Nombre de Participante Persona Natural');return true;"
			onmouseOut="javascript:mensaje_status(' ');return true;" /></div>
		</td>
	</tr>
</table>
<table class="punteadoTabla" width="600px">
	...
	<tr>
		<td width="130">Raz&oacute;n Social</td>
		<td><input type="text" name="area3ParticipanteRazon"
			style="width: 130" maxlength="150" onblur="solonumlet(this)"></td>
	</tr>
	<tr>
		<td width="130">Siglas</td>
		<td><input type="text" name="area3Siglas" style="width: 130"
			maxlength="60" onblur="sololet(this)"></td>
	</tr>
	<%if (flagInterno) { %>
	<tr>
		<td width="130"><input type="checkbox" name="checkInactivosPJ1"
			checked> Incluir Inactivos</td>
		<td>&nbsp;</td>
	</tr>
	<%}%>
...
<table cellspacing=0 border="0">
	<tr>
		<td colspan="3" align="center">
		<div id="ocultar7"><input type="button" class="formbutton"
			onclick="javascript:onclick=doBuscar(3,2)" value="Buscar"
			onmouseover="javascript:mensaje_status('Busqueda de Registro de Propiedad Inmueble por Nombre de Participante Persona Juridica');return true;"
			onmouseOut="javascript:mensaje_status(' ');return true;" /></div>
		</td>
	</tr>
</table>
...
<% if (flagInterno==true) { %> <!--Tarifario--> <%-- *******************    DIV 7 (Predios)      *************************** --%>
<layer id="narea7">
...
<table class="punteadoTablaTop">
	<tr>
		...
		<td width="135"><select name="area3PredioDepartamento"
			onchange=llenaComboHijo(); style="width: 130">
			...
			<option value=<%=bean.getValue01()%>
				<%if(bean.getValue01().equals(depLima)){%> selected <%}%>><%=bean.getValue02()%></option>
			<%}%>
		</select>
		<td width="140">Provincia</td>
		<td width="135"><select name="area3PredioProvincia"
			onchange=llenaComboHijo2(); style="width: 130"></select></td>
		<td width="90">&nbsp;</td>
	</tr>
	<tr>
		<td width="110">Distrito</td>
		<td width="135"><SELECT name="area3PredioDistrito"
			style="width: 130"></SELECT></td>
		<td width="140">&nbsp;</td>
		<td width="135">&nbsp;</td>
		<td width="90">&nbsp;</td>
	</tr>
	<tr>
		...
		<td width="135"><SELECT name="area3PredioTipoZona">
			<logic:iterate name="arreglo8" id="item8" scope="request">
				<option value="<bean:write name="item8" property="codigo"/>"><bean:write
					name="item8" property="descripcion" /></option>
			</logic:iterate>
		</SELECT></td>
		<td width="140">Nombre Zona</td>
		<td width="135"><input type="text" name="area3PredioNombreZona"
			size="20" style="width: 130" maxlength="100" onblur="sololet(this)"></td>
		<td width="90">&nbsp;</td>
	</tr>
	<tr>
		...
		<td width="135"><SELECT name="area3PredioTipoVia">
			<logic:iterate name="arreglo9" id="item9" scope="request">
				<option value="<bean:write name="item9" property="codigo"/>"><bean:write
					name="item9" property="descripcion" /></option>
			</logic:iterate>
		</SELECT></td>
		<td width="140">Nombre V&iacute;a</td>
		<td width="135"><input type="text" name="area3PredioNombreVia"
			size="20" style="width: 130" maxlength="100" onblur="sololet(this)"></td>
		<td width="90">&nbsp;</td>
	</tr>
	<tr>
		...
		<td width="135"><SELECT name="area3TipoNumerac">
			<logic:iterate name="arreglo10" id="item10" scope="request">
				<option value="<bean:write name="item10" property="codigo"/>"><bean:write
					name="item10" property="descripcion" /></option>
			</logic:iterate>
		</SELECT></td>
		<td width="140">N&uacute;mero</td>
		<td width="135"><input type="text" name="area3PredioNumero"
			size="5" maxlength="100" onblur="sololet(this)"></td>
		<td width="90">&nbsp;</td>
	</tr>
	<tr>
		...
		<td width="135"><input type="text" name="area3PredioInteriorNro"
			size="5" maxlength="100" onblur="sololet(this)"></td>
...
<table cellspacing=0 border="0">
	<tr>
		<td colspan="3" align="center">
		<div id="ocultar8"><input type="button" class="formbutton"
			onclick="javascript:onclick=doBuscar(3,3)" value="Buscar"
			onmouseover="javascript:mensaje_status('Busqueda de Registro de Predios');return true;"
			onmouseOut="javascript:mensaje_status(' ');return true;" /></div>
		</td>
	</tr>
</table>
...
<table class=cabeceraformulario>
	<tr>
		<td width="673" colspan="9"><strong><font
			color="#949400" size="2">B&uacute;squeda Registro de
		Miner&iacute;a</font></strong></td>
	</tr>
</table>
<table class="punteadoTablaTop" width="600">
	<tr>
		<td width="130">Derecho Minero</td>
		<td><input type="text" name="area3MineriaDerechoMinero"
			maxlength="100" onblur="sololet(this)"></td>
	</tr>
	<tr>
		<td width="130">Sociedad</td>
		<td><input type="text" name="area3MineriaSociedad"
			maxlength="100" onblur="sololet(this)"></td>
	</tr>
</table>
<table cellspacing=0 border="0">
	<tr>
		<td colspan="3" align="center">
		<div id="ocultar9"><input type="button" class="formbutton"
			onclick="javascript:onclick=doBuscar(3,41)" value="Buscar" /></div>
		</td>
	</tr>
</table>
</div>
...
<table width="600px">
	<tr>
		<td colspan=2><strong><font color="#949400" size="2">B&uacute;squeda
		Registro Embarcaciones Pesqueras</font></strong></td>
	</tr>
</table>
<table class="punteadoTablaTop" width="600px">
	<tr>
		<td width="130">N&uacute;mero Matr&iacute;cula</td>
		<td><input type="text" name="area3EmbarcacionNumeroMatricula"
			maxlength="15" onblur="sololet(this)"></td>
	</tr>
	<tr>
		<td width="130">Nombre Embarcaci&oacute;n</td>
		<td><input type="text" name="area3EmbarcacionNombre"
			maxlength="100" onblur="sololet(this)"></td>
	</tr>
</table>
<table cellspacing=0 border="0">
	<tr>
		<td colspan="3" align="center">
		<div id="ocultar10"><input type="button" class="formbutton"
			onclick="javascript:onclick=doBuscar(3,51)" value="Buscar"
...
<table cellspacing=0>
	<tr>
		<td><strong><font color="#949400" size="2">B&uacute;squeda
		Registro Buques</font></strong></td>
	</tr>
</table>
<table class="punteadoTablaTop" width="600">
	<tr>
		<td width="130">N&uacute;mero Matr&iacute;cula</td>
		<td><input type="text" name="area3BuqueNumeroMatricula"
			style="width: 133" maxlength="15" onblur="sololet(this)"></td>
	</tr>
	<tr>
		<td width="130">Nombre Embarcaci&oacute;n</td>
		<td><input type="text" name="area3BuqueNombre" style="width: 133"
			maxlength="100" onblur="sololet(this)"></td>
	</tr>
</table>
<table cellspacing=0 border="0">
	<tr>
		<td colspan="3" align="center">
		<div id="ocultar11"><input type="button" class="formbutton"
			onclick="javascript:onclick=doBuscar(3,61)" value="Buscar"
...
<table class="punteadoTabla" width="600">
	<tr>
		<td colspan="2"><strong><font color="#949400" size="2">B&uacute;squeda
		Registro Aeronaves</font></strong></td>
	</tr>
	<tr>
		<td width="130">N&uacute;mero Matr&iacute;cula</td>
		<td><input type="text" name="area3AeronaveNumeroMatricula"
			maxlength="15" style="width: 133" onblur="sololet(this)"></td>
	</tr>
</table>
<br>
<table cellspacing=0 border="0">
	<tr>
		<td colspan="3" align="center">
		<div id="ocultar12"><input type="button" class="formbutton"
			onclick="javascript:onclick=doBuscar(3,7)" value="Buscar"
			onmouseover="javascript:mensaje_status('Busqueda de Registro de Aereonaves por Numero de Matricula');return true;"
			onmouseOut="javascript:mensaje_status(' ');return true;" /></div>
		</td>
	</tr>
</table>
...
<table class="punteadoTablaTop" width="600">
	<tr>
		<td width="130">Apellido Paterno</td>
		<td><input type="text" name="area3AeronaveApePat" maxlength="30"
			style="width: 133" onblur="sololet(this)"></td>
	</tr>
	<tr>
		<td width="130">Apellido Materno</td>
		<td><input type="text" name="area3AeronaveApeMat" maxlength="30"
			style="width: 133" onblur="sololet(this)"></td>
	</tr>
	<tr>
		<td width="130">Nombres</td>
		<td><input type="text" name="area3AeronaveNombre" maxlength="40"
			style="width: 133" onblur="sololet(this)"></td>
	</tr>
</table>
<br>
<table cellspacing=0 border="0">
	<tr>
		<td colspan="3" align="center">
		<div id="ocultar13"><input type="button" class="formbutton"
			onclick="javascript:onclick=doBuscar(3,8)" value="Buscar"
			onmouseover="javascript:mensaje_status('Busqueda de Registro de Aereonaves por Persona Natural');return true;"
			onmouseOut="javascript:mensaje_status(' ');return true;" /></div>
		</td>
	</tr>
</table>
...
<table class="punteadoTablaTop" width="600px">
	<tr>
		<td width="130">Raz&oacute;n Social</td>
		<td><input type="text" name="area3AeronaveRazon" maxlength="150"
			style="width: 133" onblur="sololet(this)"></td>
	</tr>
	<tr>
		<td width="130">Siglas</td>
		<td><input type="text" name="area3SiglasB" maxlength="50"
			style="width: 133" onblur="sololet(this)"></td>
	</tr>
</table>
<br>
<table cellspacing=0 border="0">
	<tr>
		<td colspan="3" align="center">
		<div id="ocultar14"><input type="button" class="formbutton"
			onclick="javascript:onclick=doBuscar(3,9)" value="Buscar"
			onmouseover="javascript:mensaje_status('Busqueda de Registro de Aereonaves por Organizacion');return true;"
			onmouseOut="javascript:mensaje_status(' ');return true;" /></div>
		</td>
	</tr>
</table>
...
</layer> <layer id="narea4">
<div id="area4"
	style="position: absolute; left: < %=positionLeft% > px; top: < %=positionTop% > px;  visibility: ">
<table cellspacing=0>
	<tr>
		<td><strong><font color="#949400" size="2">B&uacute;squeda
		Registro de Propiedad Mueble por Propietario</font></strong></td>
	</tr>
</table>
...
--%>
	...
	<tr>
		<td colspan=5><strong><font color="#949400" size="2">Buscar
		por Propietario Persona Natural</font></strong></td>
	</tr>
	<tr>
		<td width="130">Apellido Paterno</td>
		<td><input type="text" name="area4PropietarioApePat"
			style="width: 130" maxlength="30" onblur="sololet(this)"></td>
	</tr>
	<tr>
		<td width="130">Apellido Materno</td>
		<td><input type="text" name="area4PropietarioApeMat"
			style="width: 130" maxlength="30" onblur="sololet(this)"></td>
	</tr>
	<tr>
		<td width="130">Nombres</td>
		<td><input type="text" name="area4PropietarioNombre"
			style="width: 130" maxlength="40" onblur="sololet(this)"></td>
	</tr>

	<%if (flagInterno) { %>
	<tr>
		<td width="130"><input type="checkbox" name="checkInactivosPN4"
			checked> Incluir Inactivos</td>
		<td>&nbsp;</td>
	</tr>
	<%}%>
...
<table cellspacing=0 border="0">
	<tr>
		<td colspan="3" align="center">
		<div id="ocultar15"><input type="button" class="formbutton"
			onclick="javascript:onclick=doBuscar(4,1)" value="Buscar"
			onmouseover="javascript:mensaje_status('Busqueda de Registro de Propiedad Inmueble por Nombre de Propietario Persona Natural');return true;"
			onmouseOut="javascript:mensaje_status(' ');return true;" /></div>
		</td>
	</tr>
</table>
<table class="punteadoTabla" width="600">
	<tr>
		<td colspan=2><strong><font color="#949400" size="2">Buscar
		por Propietario Persona Juridica</font></strong></td>
	</tr>
	<tr>
		<td width="130">Raz&oacute;n Social</td>
		<td><input type="text" name="area4PropietarioRazon"
			style="width: 130" maxlength="100" onblur="solonumlet(this)"></td>
	</tr>
	<%if (flagInterno) { %>
	<tr>
		<td width="130"><input type="checkbox" name="checkInactivosPJ4"
			checked> Incluir Inactivos</td>
		<td>&nbsp;</td>
	</tr>
	<%}%>
...
<table cellspacing=0 border="0">
	<tr>
		<td colspan="3" align="center">
		<div id="ocultar16"><input type="button" class="formbutton"
			onclick="javascript:onclick=doBuscar(4,2)" value="Buscar"
			onmouseover="javascript:mensaje_status('Busqueda de Registro de Propiedad Inmueble por Nombre de Propietario Persona Juridica');return true;"
			onmouseOut="javascript:mensaje_status(' ');return true;" /></div>
		</td>
	</tr>
</table>
<table class="punteadoTabla" width="600">
	<tr>
		<td colspan=2><strong><font color="#949400" size="2">Buscar
		por N&uacute;mero de Motor</font></strong></td>
	</tr>
	<tr>
		<td width="130">N&uacute;mero de Motor</td>
		<td><input type="text" name="area4NumMotor" style="width: 130"
			maxlength="30" onblur="solonumlet(this)"></td>
	</tr>
	<%if (flagInterno) { %>
	<tr>
		<td width="130"><input type="checkbox" name="checkInactivosNM4"
			checked> Incluir Inactivos</td>
		<td>&nbsp;</td>
	</tr>
	<%}%>
...
<table cellspacing=0 border="0">
	<tr>
		<td colspan="3" align="center">
		<div id="ocultar17"><input type="button" class="formbutton"
			onclick="javascript:onclick=doBuscar(4,3)" value="Buscar"
			onmouseover="javascript:mensaje_status('Busqueda de Registro de Propiedad Inmueble por Número de Motor');return true;"
			onmouseOut="javascript:mensaje_status(' ');return true;" /></div>
		</td>
	</tr>
</table>
<table class="punteadoTabla" width="600">
	<tr>
		<td colspan=2><strong><font color="#949400" size="2">Buscar
		por Chasis</font></strong></td>
	</tr>
	<tr>
		<td width="130">N&uacute;mero de Serie</td>
		<td><input type="text" name="area4Chasis" style="width: 130"
			maxlength="35" onblur="solonumlet(this)"></td>
	</tr>
	<%if (flagInterno) { %>
	<tr>
		<td width="130"><input type="checkbox" name="checkInactivosCH4"
			checked> Incluir Inactivos</td>
		<td>&nbsp;</td>
	</tr>
	<%}%>
...
<table cellspacing=0 border="0">
	<tr>
		<td colspan="3" align="center">
		<div id="ocultar18"><input type="button" class="formbutton"
			onclick="javascript:onclick=doBuscar(4,4)" value="Buscar"
			onmouseover="javascript:mensaje_status('Busqueda de Registro de Propiedad Inmueble por Número de Chasis');return true;"
			onmouseOut="javascript:mensaje_status(' ');return true;" /></div>
		</td>
	</tr>
</table>
...
</layer> <%-- inicio: jrosas 11-07-07 --%> <%-- *******************    DIV 12               *************************** --%>
<layer id="narea12">
<div id="area12" style="visibility:visible">
<table>
	<tr>
		<td><strong><font color="#949400" size="2">B&uacute;squeda
		Registro Mobiliario de Contratos por Participante</font></strong></td>
	</tr>
</table>
<table>
	<tr>
...
<table class="punteadoTablaTop" width="600">
	<tr>
		...
		<td><input type="text" name="txtApellidoPaterno"
			style="width: 130" maxlength="30" onblur="sololet(this)"></td>
	</tr>
	<tr>
		<td width="130">Apellido Materno</td>
		<td><input type="text" name="txtApellidoMaterno"
			style="width: 130" maxlength="30" onblur="sololet(this)"></td>
	</tr>
	<tr>
		<td width="130">Nombres</td>
		<td><input type="text" name="txtNombres" style="width: 130"
			maxlength="40" onblur="sololet(this)"></td>
	</tr>
</table>
<table cellspacing=0 border="0">
	<tr>
		<td colspan="3" align="center">
		<div id="ocultar19"><input type="button" class="formbutton"
			onclick="javascript:onclick=doBuscarRMC(3,1)" value="Buscar"
			onmouseover="javascript:mensaje_status('Busqueda de Registro de Mobiliario de Contratos por Nombre de Participante Persona Natural');return true;"
			onmouseOut="javascript:mensaje_status(' ');return true;" /></div>
		</td>
	</tr>
</table>
<table class="punteadoTablaTop" width="600">
	...
	<tr>
		<td width="130">Raz&oacute;n Social</td>
		<td><input type="text" name="txtRazonSocial" style="width: 130"
			maxlength="150" onblur="solonumlet(this)"></td>
	</tr>
	<tr>
		<td width="130">Siglas</td>
		<td><input type="text" name="txtSiglas" style="width: 130"
			maxlength="60" onblur="sololet(this)"></td>
	</tr>
</table>
<table cellspacing=0 border="0">
	<tr>
		<td colspan="3" align="center">
		<div id="ocultar20"><input type="button" class="formbutton"
			onclick="javascript:onclick=doBuscarRMC(3,2)" value="Buscar"
			onmouseover="javascript:mensaje_status('Busqueda de Registro de Mobiliario de Contratos por Nombre de Participante Persona Juridica');return true;"
			onmouseOut="javascript:mensaje_status(' ');return true;" /></div>
		</td>
	</tr>
</table>
<table class="punteadoTabla" width="600">
	<tr>
		<td colspan=2><strong><font color="#949400" size="2">Buscar
		por Tipo y Número de Documento</font></strong></td>
	</tr>
	<tr>
		...
		<td><select name="cboTipoDocumento">
			...
			<logic:iterate name="arrDocu" id="item1" scope="request">
				<option value="<bean:write name="item1" property="codigo"/>"><bean:write
					name="item1" property="descripcion" /></option>
			</logic:iterate>
		</select></td>
	</tr>
	<tr>
		<td width="130">Número de Documento</td>
		<td><input type="text" name="txtNumeroDocumento"
			style="width: 130" maxlength="15"></td>
	</tr>
	<tr>
		<td width="90" colspan="2">
		<div id="ocultar21"><input type="button" class="formbutton"
			onclick="javascript:onclick=doBuscarRMC(3,3)" value="Buscar"
			onmouseover="javascript:mensaje_status('Busqueda de Registro de Mobiliario de Contratos por Tipo y Número de Documento');return true;"
			onmouseOut="javascript:mensaje_status(' ');return true;" /></div>
		</td>
	</tr>
</table>
...
<table class="punteadoTablaTop">
	...
	<tr>
		...
		<td><input type="text" name="txtNumeroPlaca" style="width: 130"
			maxlength="7" onblur="sololet(this)"></td>
	</tr>
	<tr>
		<td width="130">Otros datos</td>
		<td><input type="text" name="txtOtrosDatos" style="width: 130"
			maxlength="100" onblur="sololet(this)"></td>
	</tr>
</table>
<table cellspacing=0 border="0">
	<tr>
		<td colspan="3" align="center">
		<div id="ocultar22"><input type="button" class="formbutton"
			onclick="javascript:onclick=doBuscarRMC(3,4)" value="Buscar"
			onmouseover="javascript:mensaje_status('Busqueda de Registro de Mobiliario de Contratos por Bienes');return true;"
			onmouseOut="javascript:mensaje_status(' ');return true;" /></div>
		</td>
	</tr>
</table>
...
<table>
	<tr>
		<td colspan="5"><font color="#949400">(*)Ingresar datos
		sin guiones y sin espacios en blanco</font></td>
	</tr>
</table>
<br>
<table class=formulario cellspacing=0
	...
	<tr>
		<td align="center" valign="center">(*)Las partidas
		correspondientes a los libros: Prenda Agrícola, Prenda
		Industrial,Prenda Global y Flotante y Prenda minera se visualizan a
		través del área registral: Registro Mobiliario de Contratos. Las
		partidas del Registro Fiscal de Ventas a Plazo a través del Registro
		Mobiliario de Contratos o el Registro de Propiedad Vehícular, según
		corresponda</td>
	</tr>
</table>
</div>
</layer> <!--  <layer id="narea13" visibility="hide">
...
--> <%-- FIN: jrosas 11-07-07 --%> <!-- Inicio:jascencio:16/07/07 
	CC:REGMOBCON-2006 --> <layer id="narea15" visibility="hide">
<div id="area15" style="visibility:hidden;">
<table>
	<tr>
		<td><strong><font color="#949400" size="2">Búsqueda
		del Sistema Integrado Garantias y Contratos por participante</font></strong></td>
	</tr>
</table>
<table class="punteadoTabla" width="600px">
	<tr>
		<td colspan=2><strong><font color="#949400" size="2">Búsqueda
		por Participante Persona Natural</font></strong></td>
	</tr>
	<tr>
		<td width="200">Apellido Paterno</td>
		<td><input type="text" name="txtParticipanteApePatArea15"
			style="width: 130" maxlength="30" onblur="sololet(this)"></td>
	</tr>
	<tr>
		<td width="200">Apellido Materno</td>
		<td><input type="text" name="txtParticipanteApeMatArea15"
			style="width: 130" maxlength="30" onblur="sololet(this)"></td>
	</tr>
	<tr>
		<td width="200">Nombres</td>
		<td><input type="text" name="txtParticipanteNombreArea15"
			style="width: 130" maxlength="40" onblur="sololet(this)"></td>
	</tr>
</table>
<table cellspacing=0 border="0">
	<tr>
		<td colspan="3" align="center">
		<div id="ocultar23"><input type="button" class="formbutton"
			onclick="javascript:onclick=doBuscarSIGC(4,1)" value="Buscar"
			onmouseover="javascript:mensaje_status('Busqueda del Sistema Integrado Garantías y Contratos por Participante Persona Natural');return true;"
			onmouseOut="javascript:mensaje_status(' ');return true;"></div>
		</td>
	</tr>
</table>
<table class="punteadoTabla" width="600px">
	...
	<tr>
		...
		<td><input type="text" name="txtParticipanteRazonArea15"
			style="width: 130" maxlength="150" onblur="solonumlet(this)"></td>
	</tr>
	<tr>
		<td width="200">Siglas</td>
		<td><input type="text" name="txtSiglasArea15" style="width: 130"
			maxlength="60" onblur="sololet(this)"></td>
	</tr>
</table>
<table cellspacing=0 border="0">
	<tr>
		<td colspan="3" align="center">
		<div id="ocultar24"><input type="button" class="formbutton"
			onclick="javascript:onclick=doBuscarSIGC(4,2)" value="Buscar"
			onmouseover="javascript:mensaje_status('Busqueda del Sistema Integrado Garantías y Contratos por Participante Persona Juridica');return true;"
			onmouseOut="javascript:mensaje_status(' ');return true;" /></div>
		</td>
	</tr>
</table>
...
<table class="punteadoTablaTop" width="600px">
	<tr>
		...
		<td><select name="cboTipoDocumentoArea15">
			<option value="">--</option>
			<logic:iterate name="arrDocu" id="item1" scope="request">
				<option value="<bean:write name="item1" property="codigo"/>">
				<bean:write name="item1" property="descripcion" /></option>
			</logic:iterate>
		</select></td>
	</tr>
	<tr>
		<td width="200">Número de Documento</td>
		<td><input type="text" name="txtNumeroDocumentoArea15"
			maxlength="15"></td>
	</tr>
</table>
<table cellspacing=0 border="0">
	<tr>
		<td colspan="3" align="center">
		<div id="ocultar25"><input type="button" class="formbutton"
			onclick="javascript:onclick=doBuscarSIGC(4,3)" value="Buscar"
			onmouseover="javascript:mensaje_status('Busqueda del Sistema Integrado Garantías y Contratos por Tipo y Número de Documento');return true;"
			onmouseOut="javascript:mensaje_status(' ');return true;"></div>
		</td>
	</tr>
</table>
<table>
	<tr>
		<td><strong><font color="#949400" size="2">Búsqueda
		por Bienes</font></strong></td>
	</tr>
</table>
<table class="punteadoTablaTop" cellspacing=0 width="600px">
	<tr>
		<td width="200">Placa</td>
		<td><input type="text" name="txtNumeroPlacaArea15"
			maxlength="15" onblur="mayuscula(this)"></td>
	</tr>
	<tr>
		<td width="200">Nro. Matricula(embarcaciones pesqueras, buques y
		aeronaves)</td>
		<td><input type="text" name="txtNumeroMatriculaArea15"
			maxlength="35" onblur="mayuscula(this)"></td>
	</tr>
	<tr>
		<td width="200">Nombre(embarcaciones pesqueras y buques)</td>
		<td><input type="text" name="txtNombreBienArea15" maxlength="15"
			onblur="mayuscula(this)"></td>
	</tr>
	<tr>
		<td width="200">Nro. Serie(motores aeronaves y otros)</td>
		<td><input type="text" name="txtNumeroSerieArea15" maxlength="35"
			onblur="mayuscula(this)"></td>
	</tr>
</table>
<table cellspacing=0 border="0">
	<tr>
		<td colspan="3" align="center">
		<div id="ocultar26"><input type="button" class="formbutton"
			onclick="javascript:onclick=doBuscarSIGC(4,4)" value="Buscar"
			onmouseover="javascript:mensaje_status('Busqueda del Sistema Integrado Garantías y Contratos por Bienes');return true;"
			onmouseOut="javascript:mensaje_status(' ');return true;"></div>
		</td>
	</tr>
</table>
</div>
</layer> <%if(flagInterno == true){
