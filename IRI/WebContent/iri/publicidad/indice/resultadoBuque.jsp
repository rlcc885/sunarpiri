...
<tr>
  ...
  <tr class=grilla2>
	...
	<td><%=bean.getBuqueMatricula()%></td>
	<td><%=bean.getBuqueNombre()%></td>
...
{ %>
  	  ...
  	  <div id="HOJA2"> 
  	  <a href="/iri/Certificados.do?state=guardarDatosBasicos&hidTipo=B&criterio=<%=request.getAttribute("criterioBusqueda")%>&flagCertBusq=<%=flag%>&flagBusq=I" onmouseover="javascript:mensaje_status('Solicitar Certificado');return true;" onmouseOut="javascript:mensaje_status(' ');return true;"><IMG height=25 hspace=4 src="images/btn_solic.gif" width=83 align=absMiddle vspace=5 border=0></a>
  	  </div></td>
  	  <%}%>
  	 <!-- Fin:mgarate:31/05/2007 -->
	<td width="50%" align="right">
