...
<tr bgcolor="#949400">
	...
	<th><font color="white">Oficinca Registral</font></th>
	...
	<th><font color="white">Nombre Buque</font></th>
...
{ %>
	  	  ...
	  	  <div id="HOJA2"> 
	  	  	<input type="button" class="formbutton" value="Solicitar" onclick="javascript:solicitar()" onmouseover="javascript:mensaje_status('Solicitar Certificado');return true;" onmouseOut="javascript:mensaje_status(' ');return true;" />
	  	  </div>
	  	</td>
  	  <%}%>
  	 <!-- Fin:mgarate:31/05/2007 -->
