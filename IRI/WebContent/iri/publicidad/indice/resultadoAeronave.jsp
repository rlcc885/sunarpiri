...
{	
	...
	//************************************************************************************
	document.frm1.action="/iri/CertificadosIRI.do?state=guardarDatosBasicos&hidTipo=B&flagCertBusq=<%=flag%>&criterio=<%=request.getAttribute("criterioBusqueda")%>&flagBusq=I";
	document.frm1.submit();
}
</script>
...
<table border="1" >
  <tr bgcolor="#949400">
	...
	<th><font color="white">Matr&iacute;cula</font></th>
	<th><font color="white">Tipo titular</font></th>
	<th><font color="white">Titular</font></th>	
  ...
  <tr class=grilla2>
	...
	<td><%=bean.getAeronaveMatricula()%></td>
	<td><%=bean.getAeronaveTipoTitular()%></td>
	<td><%=bean.getAeronaveTitular()%></td>	
	...
	<%if(certi){%>
	<td align="center">
	  <a href="/iri/CertificadosIRI.do?state=guardarDatosBasicos&refnum_part=<%=bean.getRefNumPart()%>&noPartida=<%=bean.getNumPartida()%>&hidOfic=<%=bean.getOficRegDescripcion()%>&hidTipo=L">
