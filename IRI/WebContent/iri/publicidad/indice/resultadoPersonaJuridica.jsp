...
<input type="hidden" name="flagCertBusq" value=""/>
<%
} %>
...
{ %>
  	<%if(flag!=null){
  	 ...
  	 %>
  	  ...
  	  <div id="HOJA2"> 
  	  	<input type="button" class="formbutton" value="Enviar" onclick="javascript:enviar()" onmouseover="javascript:mensaje_status('Solicitar Certificado');return true;" onmouseOut="javascript:mensaje_status(' ');return true;"/>
  	  </div></td>
  	 <%}}}%>
  	 <!-- Fin:mgarate:31/05/2007 -->
	<td width="50%" align="right">
...
<script LANGUAGE="JavaScript">
  if (<%= request.getAttribute("criterioBusqueda")!= null %>){
	 document.frm1.criterio.value = "<%= request.getAttribute("criterioBusqueda")%>" 
  }	
  <% String flag2 = (String)request.getAttribute("flagCertBusq"); 
    if (flag2 != null){ %>
	 document.frm1.flagCertBusq.value = "<%= flag2 %>" 
  <%}%>	  
