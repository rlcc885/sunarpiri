...
<div class="innertube">
	...
	<br>
	<b><font color="#949400">SERVICIOS &gt;&gt;</font><font color="#666666">B&uacute;squeda Directa de Partidas &gt;&gt;</font>&nbsp;Detalle</b>
	<br>
    ...
    <td width="50%"> 
      <table width="100%" border="1" cellspacing="0">
        ...
        <tr> 
          ...
          <td align="center" height="30">
            <a href="<%=request.getContextPath()%>/CertificadosIRI.do?state=guardarDatosBasicos&refnum_part=<%=request.getAttribute("refnum_part")%>&noPartida=<%=request.getAttribute("partida")%>&hidOfic=<bean:write name="bDatos" property="nomOfi"/>&area=24000&hidTipo=L">
...
<TABLE class="grilla" border=0 width=780 >
  <TBODY>
  <TR>
  ...
  <TBODY>
    ...
    <logic:present name="titupend">
      ...
      <TR>
        ...
        <TD align=center vAlign=center borderColor=#000000 borderColorLight=#000000 width=20% bgColor=#f6f6f6 borderColorDark=#000000>
          <a href="<%=request.getContextPath()%>/BusquedaTituloIRI.do?state=buscarXNroTituloDet&ano=<bean:write name="item4" property="ano"/>&numtitu=<bean:write name="item4" property="numTitulo"/>&oficinas=<bean:write name="item4" property="regPubId"/>%7C<bean:write name="item4" property="oficRegId"/>&txt_oficinas=Lima&areareg=<bean:write name="item4" property="areaRegistralId"/>">
