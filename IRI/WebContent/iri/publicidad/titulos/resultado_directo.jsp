...
<script language="javascript">
	...
	function Ordenar(){ 
		...
		document.form1.action="/iri/BusquedaTituloIRI.do?state=buscaOrden&pagina=1";
	...
	*/ 
		document.form1.method="POST";
		document.form1.action="/iri/BusquedaTituloIRI.do?state=buscaOrden&pagina=" + pagina;
		document.form1.submit();
	/*
	}
	else
