		...
		<div class="innertube">
			...
			<logic:notPresent name="presentado">
				<table cellspacing=0  class="punteadoTabla" width="600px">
			        <tr> 
			          <td width="167"><b>Tipo Registro</b></td>
			...
			<table cellspacing=0  class="punteadoTabla" width="600px">
				<logic:notPresent name="presentado">
			        <tr> 
			          <td width="167"><b>Actos Registrales</b></td>
			          <td>
		        ...
		        <tr> 
		          <td width="167"><b>Resultado de la calificaci&oacute;n</b></td>
		          <td>
		        ...
		        <tr> 
		          <td width="167"><b>Mensaje</b></td>
		          <td><bean:write name="lista" property="mensaje"/></td>
		        </tr>
		        <tr> 
		          <td width="167"><b>Fecha Hora de Presentaci&oacute;n</b></td>
		          <td><bean:write name="lista" property="fecha"/></td>
		        </tr>
				<logic:notPresent name="presentado">
			        <tr> 
			          <td width="167"><b>Vencimiento</b></td>
