...
<jsp:useBean id="lista" scope="request" class="gob.pe.sunarp.extranet.publicidad.busquedagarantiascontratos.list.EmpresaList"/>
<%@page import="gob.pe.sunarp.extranet.publicidad.busquedagarantiascontratos.bean.Empresa"%>
<%@page import="gob.pe.sunarp.extranet.publicidad.busquedagarantiascontratos.list.*"%>
            ...
            <div>
                ...
                <table class=grilla2 cellspacing=3 >
                    <%for (int i=1;i<lista.size();i++){
                            Empresa e = lista.getList(i);%>
                    <tr >
                        <td><%=e.getRazon_social()%></td>
                        <td><%=e.getLugar()%></td>
                        <td><%=e.getTipo()%></td>
                        <td><%=e.getEstado()%></td>
                        <td><%=e.getDescripcion_libro()%></td>
                    </tr>
                    <%}%>
                </table>
            </div>
