  ...
  for (int i=0; i < arr1.size(); i++)
  	...
  	%>
			  <tr class=grilla2>
				...
				<td align="center"><div id="ocultar"><input name="image2" type="image" onclick="VerPartida('<%=bean.getNumeroPlaca()%>','<%=bean.getEstado()%>','<%=bean.getRegPubId()%>|<%=bean.getOficRegId()%>')" value="Visualizar" src="images/lupa.gif" style="border:0" onmouseover="javascript:mensaje_status('Visualizar Resumen');return true;" onmouseOut="javascript:mensaje_status(' ');return true;"></div></td>
