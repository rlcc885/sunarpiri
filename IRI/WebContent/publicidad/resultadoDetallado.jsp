...
//	ventana=window.open('/iri/Publicidad.do?state=visualizaPartida&refnum_part=' + refnum_Part,'1024x768','toolbar=no,status=yes,scrollbars=yes,resizable=yes,location=no,menubar=no,directories=no,width=950,height=650, top=0, left=0')
	if(clicked == false)
	{
		...
		if(doyou == true) {
		  document.frm1.action="/iri/Publicidad.do?state=buscarXPlacaDet&txt4=" + num_placa+ "&CboOficinas=" + ofic;
...
function paginar(numero)
{
	...
	{
		document.frm1.action="/iri/PublicidadMasivaRelacional.do?state=busquedaVehicular";	
	}
	if(document.frm1.registro.value=="A")
	{
		document.frm1.action="/iri/PublicidadMasivaRelacional.do?state=busquedaAeroNave";	
	}
	if(document.frm1.registro.value=="B")
	{
		document.frm1.action="/iri/PublicidadMasivaRelacional.do?state=busquedaBuques";	
	}
	if(document.frm1.registro.value=="E")
	{
		document.frm1.action="/iri/PublicidadMasivaRelacional.do?state=busquedaEmbarcacionPesquera";	
	}
	if(document.frm1.registro.value=="R")
	{
		document.frm1.action="/iri/PublicidadMasivaRelacional.do?state=busquedaRMC";	
	}
	document.frm1.submit();
}
...
{ 
  ...
  if(doyou == true) {
	...
	document.frm1.action="/iri/Publicidad.do?state=detallePartidaRMC&refnum_part=" + refnum_Part;	
	document.frm1.submit();
  }
}
function ordenar(valor)
{
	...
	if(document.frm1.registro.value=="V")
	{
		document.frm1.action="/iri/PublicidadMasivaRelacional.do?state=busquedaVehicular&criterio="+valor;	
	}
	if(document.frm1.registro.value=="A")
	{
		document.frm1.action="/iri/PublicidadMasivaRelacional.do?state=busquedaAeroNave&criterio="+valor;	
	}
	if(document.frm1.registro.value=="B")
	{
		document.frm1.action="/iri/PublicidadMasivaRelacional.do?state=busquedaBuques&criterio="+valor;	
	}
	if(document.frm1.registro.value=="E")
	{
		document.frm1.action="/iri/PublicidadMasivaRelacional.do?state=busquedaEmbarcacionPesquera&criterio="+valor;	
	}
	if(document.frm1.registro.value=="R")
	{
		document.frm1.action="/iri/PublicidadMasivaRelacional.do?state=busquedaRMC&criterio="+valor;	
	}
	document.frm1.submit();
}
function Imprime()
	...
	<logic:equal name="regis" value="A">
		...
		<logic:iterate name="listaResult" id="lista">
			<tr class="grilla2">
				...
				<td align="center"><a href="javascript:VerAsientos('<bean:write name="lista" property="refnumpart"/>','<bean:write name="lista" property="estado"/>');"><image src="/iri/images/lupa.gif" style="border:0" onmouseover="javascript:mensaje_status('Ver Asientos');return true;" onmouseOut="javascript:mensaje_status(' ');return true;"></a></td>
				<%if(certi){%>
				<td align="center"><a href="/iri/Certificados.do?state=guardarDatosBasicos&refnum_part=<bean:write name="lista" property="refnumpart"/>&noPartida=<bean:write name="lista" property="numeroPartida"/>&hidOfic=<bean:write name="lista" property="nombreoficina"/>&area=<bean:write name="lista" property="areaid"/>&hidTipo=L"><image src="/iri/images/copia.gif" style="border:0" onmouseover="javascript:mensaje_status('Solicitar Partida');return true;" onmouseOut="javascript:mensaje_status(' ');return true;"></a></td>
				<%}%>
			</tr>
		</logic:iterate>
		...
		<logic:iterate name="listaResult" id="lista">
			<tr class="grilla2">
				...
				<logic:equal name="lista" property="codLibro" value="099">
					<image src="/iri/images/lupa.gif" style="border:0" onmouseover="javascript:mensaje_status('Ver Partida');return true;" onmouseOut="javascript:mensaje_status(' ');return true;">
				</logic:equal>
				</a>
				</td>
				<td align="center"><a href="javascript:VerAsientos('<bean:write name="lista" property="refnumpart"/>','<bean:write name="lista" property="estado"/>');"><image src="/iri/images/lupa.gif" style="border:0" onmouseover="javascript:mensaje_status('Ver Asientos');return true;" onmouseOut="javascript:mensaje_status(' ');return true;"></a></td>
				<%if(certi){%>
				<logic:equal name="lista" property="codLibro" value="099">
					<td align="center"><a href="/iri/Certificados.do?state=guardarDatosBasicos&refnum_part=<bean:write name="lista" property="refnumpart"/>&noPartida=<bean:write name="lista" property="numeroPartida"/>&hidOfic=<bean:write name="lista" property="nombreoficina"/>&area=<bean:write name="lista" property="areaid"/>&hidTipo=LR"><image src="/iri/images/copia.gif" style="border:0" onmouseover="javascript:mensaje_status('Solicitar Partida');return true;" onmouseOut="javascript:mensaje_status(' ');return true;"></a></td>
				</logic:equal>
