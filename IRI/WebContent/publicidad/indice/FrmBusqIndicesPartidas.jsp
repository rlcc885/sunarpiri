...
if (global_pidedis==true)
	{
	doSendChildren();
	document.frm1.action="/iri/BuscaPartidasXIndices.do?state=verFormulario";
	...
	if (param2==2)
		{
				...
				if (tieneCaracterNoValido(document.frm1.area1Razon.value)==true ||
				    tieneCaracterNoValido(document.frm1.area1Siglas.value)==true)
					{
					alert("Por favor no ingrese caracteres no válidos");
					return;
					}				    
				ocultaDivs();
				document.frm1.action="/iri/BuscaPartidasXIndices.do?state=buscarPersonaJuridica";		
		}
}
...
if (param1 == 2)
{
	...
	if (param2==2)
		{
				...
				if (tieneCaracterNoValido(document.frm1.area2Razon1.value)==true ||
				    tieneCaracterNoValido(document.frm1.area2Siglas.value)==true)
					{
					alert("Por favor no ingrese caracteres no válidos");
					return;
					}				    								
	...
	if (param2==3)
	{
		...
		ocultaDivs();
		document.frm1.action="/iri/BuscaPartidasXIndices.do?state=buscarRazonSocial";
	}
}
if (param1 == 3)
{
	...
	if (param2==3)
		...
		if (tieneCaracterNoValido(document.frm1.area3PredioNombreZona.value)==true ||
			...
			ocultaDivs();
			document.frm1.action="/iri/BuscaPartidasXIndices.do?state=buscarPredio";
		}
	...
	if (param2==41)
		...
		ocultaDivs();
		document.frm1.action="/iri/BuscaPartidasXIndices.do?state=buscarMineria";
		}
	...
	if (param2==51)
		...
		ocultaDivs();
		document.frm1.action="/iri/BuscaPartidasXIndices.do?state=buscarEmbarcacion";
		}
	...
	if (param2==61)
		...
		ocultaDivs();
		document.frm1.action="/iri/BuscaPartidasXIndices.do?state=buscarBuque";
		}		
	...
	if (param2==7)
		...
		ocultaDivs();
		document.frm1.action="/iri/BuscaPartidasXIndices.do?state=buscarAeronaveXMatricula";
		}
	...
	if (param2==8)
		...
		ocultaDivs();
		document.frm1.action="/iri/BuscaPartidasXIndices.do?state=buscarAeronaveXNombre";
		}
	...
	if (param2==9)
		...
		ocultaDivs();
		document.frm1.action="/iri/BuscaPartidasXIndices.do?state=buscarAeronaveXRazonSocial";
		}
}
...
if (param1 == 4)
{
	...
	if (param2==1)
		...
		ocultaDivs();
		document.frm1.action="/iri/BuscaPartidasXIndices.do?state=buscarXNombreVehicular&tipo=1";
		}
	...
	if (param2==2)
		...
		// Fin:mgarate:29/05/2007
				...
				ocultaDivs();
				document.frm1.action="/iri/BuscaPartidasXIndices.do?state=buscarXNombreVehicularJuri&tipo=2";
		}
	...
	if (param2==3)
		{
		       ...
		       // Fin:mgarate:29/05/2007
				...
				ocultaDivs();
				document.frm1.action="/iri/BuscaPartidasXIndices.do?state=buscarXNombreVehicularMotor&tipo=2";
		}
	...
	if (param2==4)
		{
				...
				ocultaDivs();
				document.frm1.action="/iri/BuscaPartidasXIndices.do?state=buscarXNombreVehicularChasis&tipo=2";
		}
...
{   
  ...
  if (param1 == 3){
	 ...
	 { 
		...
		{
			ocultaDivs();
			document.frm1.action="/iri/BuscaPartidasXIndices.do?state=buscarPersonaNaturalRmc&tipo=N";
			document.frm1.submit();
		}
		else
		{
	...
	{	
		...
		ocultaDivs();
		document.frm1.action="/iri/BuscaPartidasXIndices.do?state=buscarPersonaJuridicaRmc&tipo=J";
		document.frm1.submit();
	}
	...
	if (param2==3)
	{
		...
		ocultaDivs();
	    document.frm1.action="/iri/BuscaPartidasXIndices.do?state=buscarTipoNumeroDocumentoRmc&tipo=D";
	    document.frm1.submit();
	}  
    ...
    if (param2==4)
	{
		...
		{
			ocultaDivs();
			document.frm1.action="/iri/BuscaPartidasXIndices.do?state=buscarBienesRmc&tipo=B";
			document.frm1.submit();
		}
		else
		{
	...
	if(param1==4){
		if(param2==1){
			...
			if (b1==true && (b2==true || b3==true))
				...
				ocultaDivs();
				document.frm1.action="/iri/BuscaPartidasXIndices.do?state=buscarPersonaNaturalSigc&tipo=N";
				}
			else
				{
				alert("Por favor ingrese el Apellido Paterno, y el Apellido Materno o el Nombre");
			...
			if(param2==2){
				...
				ocultaDivs();
				document.frm1.action="/iri/BuscaPartidasXIndices.do?state=buscarPersonaJuridicaSigc&tipo=J";
				...
				if(param2==3){
					...
					ocultaDivs();
			    	document.frm1.action="/iri/BuscaPartidasXIndices.do?state=buscarTipoNumeroDocumentoSigc&tipo=D";
					...
					if(param2==4){
						...
						ocultaDivs();
						document.frm1.action="/iri/BuscaPartidasXIndices.do?state=buscarBienesSigc&tipo=B";
					}
				}
			}
		}
...
<form name="frm1" method="post"><input type="hidden" name="hid1"> <input type="hidden" name="hid2"> <input type="hidden" name="pidedis" value="S"> <br>
<table class=titulo cellspacing=0>
    <tr>
        <td><font color=black>SERVICIOS &gt;&gt;</font>B&uacute;squeda de &Iacute;ndice de Partidas</td>
    </tr>
</table>
<%-- Inicio:mgarate:29/05/2007 --%>
...
<table class=formulario cellspacing=0>
    <tr>
        <td align="center" vAlign="center"><layer id="narea5" visibility="hide">
        <div id="area5" style="visibility: hidden; background-color: FFFFDD; width: 430px; border-width: 1px; border-color: 000000; border-style: solid">
...
<table class=formulario cellspacing=0>
    <tr>
        <td align="center" vAlign="center"><layer id="narea13" visibility="hide">
...
<table cellspacing=0>
    <tr>
        <td width="30%" class=formulario style="width: 373px" align=right>Area Registral: <!--select name="comboArea" size="1" onchange="Cambio(this.value)">
			<logic:iterate name="arrAreaRegistral" id="item2" scope="request">
					<logic:equal name="item2" property="codigo" value="21000">
						<option value="<bean:write name="item2" property="codigo"/>" selected> <bean:write name="item2" property="descripcion"/> </option>
					</logic:equal>
					<logic:notEqual name="item2" property="codigo" value="21000">
        ...
        <td width=2px></td>
        <td width="" class=cabeceraformulario style="width: 220px; border-bottom-style: solid" align=right><font color=red><b>COSTO TOTAL DE BUSQUEDA</b></font><input type="text" name="costo" size="2" value="0" disabled="true"></td>
    </tr>    
</table>

<table class=formulario cellspacing=0>
    <tr>
        <td align="center"><layer id="narea6">
        <div id="area6" style="visibility: visible"><a href="javascript:VentanaFlotante('/iri/acceso/mapas/MAPA1.htm')" onmouseover="javascript:mensaje_status('Identifique su Oficina Registral');return true;" onmouseOut="javascript:mensaje_status(' ');return true;">Identifique su Oficina Registral</a></div>
        </layer></td>
    </tr>
</table>
<%
...
<table class=cabeceraformulario cellspacing=0>
    <tr>
        <td>B&uacute;squeda Registro Personas Naturales por Participante</td>
    </tr>
</table>
<table class=cabeceraformulario cellspacing=0>
    <tr>
        <td>Buscar por Participante Persona Natural</td>
    </tr>
</table>
<table class=formulario cellspacing=0>
    <tr>
        <td width="160">Apellido Paterno</td>
        <td width="140"><input name="area1ApePat" style="width: 130" maxlength="30" onblur="sololet(this)"></td>
        <td width="160">Apellido Materno</td>
        <td width="140"><input name="area1ApeMat" style="width: 130" maxlength="30" onblur="sololet(this)"></td>
        <td width="31">&nbsp;</td>
    </tr>
    <tr>
        <td width="160">Nombres</td>
        <td width="140"><input name="area1Nombre" style="width: 130" maxlength="40" onblur="sololet(this)"></td>
        <td width="160">&nbsp;</td>
        <td width="140">&nbsp;</td>
        <td width="31"><div id="ocultar1"><A href="javascript:doBuscar(1,1)"><img border=0 src="images/btn_buscar2.gif"></a></div></td>
    </tr>
    <%if (flagInterno) { %>
    <tr>
        <td width="160"><input type="checkbox" name="checkInactivosPN3" checked> Incluir Inactivos</td>
        <td width="140">&nbsp;</td>
        <td width="160">&nbsp;</td>
        <td width="140">&nbsp;</td>
        <td width="31">&nbsp;</td>
...
<table class=cabeceraformulario cellspacing=0>
    <tr>
        <td>Buscar por Participante Persona Jur&iacute;dica</td>
    </tr>
</table>
<table class=formulario cellspacing=0>
    <tr>
        <td width="160">Raz&oacute;n Social</td>
        <td width="140"><input type="text" name="area1Razon" style="width: 130" maxlength="150" onblur="solonumlet(this)"></td>
        <td width="160">Siglas</td>
        <td width="140"><input type="text" name="area1Siglas" style="width: 130" maxlength="50" onblur="solonumlet(this)"></td>
        <td width="31"><div id="ocultar2"><A href="javascript:doBuscar(1,2)"><img border=0 src="images/btn_buscar2.gif"></a></div></td>
    </tr>
    <%if (flagInterno) { %>
    <tr>
        <td width="160"><input type="checkbox" name="checkInactivosPJ3" checked> Incluir Inactivos</td>
        <td width="140">&nbsp;</td>
        <td width="160">&nbsp;</td>
        <td width="140">&nbsp;</td>
        <td width="31">&nbsp;</td>
...
<table class=cabeceraformulario cellspacing=0>
    <tr>
        <td>B&uacute;squeda Registro Personas Jur&iacute;dicas por Participante</td>
    </tr>
</table>
<table class=formulario cellspacing=0>
    <tr>
    ...
    <tr>
        <td colspan=5><b>Buscar por Participante Persona Natural</b></td>
    </tr>
    <tr>
        <td width="160">Apellido Paterno</td>
        <td width="140"><input name="area2ApePat" style="width: 130" maxlength="30" onblur="sololet(this)"></td>
        <td width="160">Apellido Materno</td>
        <td width="140"><input name="area2ApeMat" style="width: 130" maxlength="30" onblur="sololet(this)"></td>
        <td width="31">&nbsp;</td>
    </tr>
    <tr>
        <td width="160">Nombres</td>
        <td width="140"><input name="area2Nombre" style="width: 130" maxlength="40" onblur="sololet(this)"></td>
        <td width="160">&nbsp;</td>
        <td width="140">&nbsp;</td>
        <td width="31"><div id="ocultar3"><A href="javascript:doBuscar(2,1)"><img border=0 src="images/btn_buscar2.gif"></a></div></td>
    </tr>
    <%if (flagInterno) { %>
    <tr>
        <td width="160"><input type="checkbox" name="checkInactivosPN2" checked> Incluir Inactivos</td>
        <td width="140">&nbsp;</td>
        <td width="160">&nbsp;</td>
        <td width="140">&nbsp;</td>
        <td width="31">&nbsp;</td>
    ...
    <tr>
        <td colspan=5><b>Buscar por Participante Persona Juridica</b></td>
    </tr>
    <tr>
        <td width="160">Raz&oacute;n Social</td>
        <td width="140"><input type="text" name="area2Razon1" style="width: 130" maxlength="150" onblur="solonumlet(this)"></td>
        <td width="160">Siglas</td>
        <td width="140"><input type="text" name="area2Siglas" style="width: 130" maxlength="50" onblur="solonumlet(this)"></td>
        <td width="31"><div id="ocultar4"><A href="javascript:doBuscar(2,2)"><img border=0 src="images/btn_buscar2.gif"></a></div></td>
    </tr>
    <%if (flagInterno) { %>
    <tr>
        <td width="160"><input type="checkbox" name="checkInactivosPJ2" checked> Incluir Inactivos</td>
        <td width="140">&nbsp;</td>
        <td width="160">&nbsp;</td>
        <td width="140">&nbsp;</td>
        <td width="31">&nbsp;</td>
  ...
  <tr>
    <td width="21">&nbsp;</td>
    <td width="89">Tipo Documento</td>
    <td width="208">
							<select name="area2TipoDocumento">
			<logic:iterate name="arreglo4" id="item4" scope="request">
				<option value="<bean:write name="item4" property="codigo"/>"><bean:write name="item4" property="descripcion"/></option>
			</logic:iterate>
							</select>
    </td>
    <td width="129">&nbsp;N&uacute;mero </td>
    <td width="161"><input type="text" name="area2NumeroDocumento"></td>
    <td width="77"></td>
  </tr>--%>
</table>
<br>
...
<table class=cabeceraformulario cellspacing=0>
    <tr>
        <td>B&uacute;squeda Registro Personas Jur&iacute;dicas por Raz&oacute;n Social</td>
    </tr>
</table>
<table class=formulario cellspacing=0>
    <tr>
        <td width="160">Raz&oacute;n Social</td>
        <td width="140"><input type="text" name="area2Razon2" style="width: 130" maxlength="250" onblur="solonumlet(this)"></td>
        <td width="160">Siglas</td>
        <td width="140"><!--input type="hidden" name="area2SiglasB"--> <input type="text" name="area2SiglasB" style="width: 130" maxlength="50" onblur="solonumlet(this)"></td>
        <td width="31"><div id="ocultar5"><A href="javascript:doBuscar(2,3)"><img border=0 src="images/btn_buscar2.gif"></a><div></td>
    </tr>
</table>
</div>
</layer> 
...
<table class=cabeceraformulario cellspacing=0>
    <tr>
        <td>B&uacute;squeda Registro de Propiedad Inmueble por Participante</td>
    </tr>
</table>
<table class=formulario cellspacing=0>
...
--%>
    ...
    <tr>
        ...
        <td width="135"><input type="text" name="area3ParticipanteApePat" style="width: 130" maxlength="30" onblur="sololet(this)"></td>
        <td width="140">Apellido Materno</td>
        <td width="135"><input type="text" name="area3ParticipanteApeMat" style="width: 130" maxlength="30" onblur="sololet(this)"></td>
        <td width="90">&nbsp;</td>
    </tr>
    <tr>
        <td width="110">Nombres</td>
        <td width="135"><input type="text" name="area3ParticipanteNombre" style="width: 130" maxlength="40" onblur="sololet(this)"></td>
        <td width="140">&nbsp;</td>
        <td width="135">&nbsp;</td>
        <td width="90"><div id="ocultar6"><A href="javascript:doBuscar(3,1)" onmouseover="javascript:mensaje_status('Busqueda de Registro de Propiedad Inmueble por Nombre de Participante Persona Natural');return true;" onmouseOut="javascript:mensaje_status(' ');return true;"><img border=0 src="images/btn_buscar2.gif"></a></div></td>
    </tr>
    <%if (flagInterno) { %>
    <tr>
        <td width="160"><input type="checkbox" name="checkInactivosPN1" checked> Incluir Inactivos</td>
        <td width="140">&nbsp;</td>
        <td width="160">&nbsp;</td>
        <td width="140">&nbsp;</td>
        <td width="31">&nbsp;</td>
    ...
    <tr>
        <td width="110">Raz&oacute;n Social</td>
        <td width="135"><input type="text" name="area3ParticipanteRazon" style="width: 130" maxlength="150" onblur="solonumlet(this)"></td>
        <td width="140">Siglas</td>
        <td width="135"><input type="text" name="area3Siglas" style="width: 130" maxlength="60" onblur="sololet(this)"></td>
        <td width="90"><div id="ocultar7"><A href="javascript:doBuscar(3,2)" onmouseover="javascript:mensaje_status('Busqueda de Registro de Propiedad Inmueble por Nombre de Participante Persona Juridica');return true;" onmouseOut="javascript:mensaje_status(' ');return true;"><img border=0 src="images/btn_buscar2.gif"></a></div></td>
    </tr>
    <%if (flagInterno) { %>
    <tr>
        <td width="160"><input type="checkbox" name="checkInactivosPJ1" checked> Incluir Inactivos</td>
        <td width="140">&nbsp;</td>
        <td width="160">&nbsp;</td>
        <td width="140">&nbsp;</td>
        <td width="31">&nbsp;</td>
...
<table class=formulario cellspacing=0>
    <tr>
        ...
        <td width="135"><select name="area3PredioDepartamento" onchange=llenaComboHijo(); style="width: 130">
...
Value05Bean bean = (Value05Bean) arrq.get(w); %>
    ...
    <tr>
        ...
        <td width="90"><div id="ocultar8"><A href="javascript:doBuscar(3,3)" onmouseover="javascript:mensaje_status('Busqueda de Registro de Predios');return true;" onmouseOut="javascript:mensaje_status(' ');return true;"><img border=0 src="images/btn_buscar2.gif"></a></div></td>
    </tr>
</table>
</div>
</layer>
...
<table class=cabeceraformulario>
    <tr bordercolor="AFAFAF" bgcolor="D7D7D7">
        ...
        <p align="left"><font color="132E4C"><strong>B&uacute;squeda Registro de Miner&iacute;a</strong></font>
        </td>
    </tr>
</table>
<table class=formulario>
    <tr>
        <td width="110">Derecho Minero</td>
        <td width="135"><input type="text" name="area3MineriaDerechoMinero" maxlength="100" onblur="sololet(this)"></td>
        <td width="140">Sociedad</td>
        <td width="135"><input type="text" name="area3MineriaSociedad" maxlength="100" onblur="sololet(this)"></td>
        <td width="90"><div id="ocultar9"><A href="javascript:doBuscar(3,41)"><img border=0 src="images/btn_buscar2.gif"></a></div></td>
    </tr>
</table>
</div>
</layer>
...
<table class=cabeceraformulario cellspacing=0>
    <tr bordercolor="AFAFAF" bgcolor="D7D7D7">
        <td width="673" colspan="9">
        <p align="left"><font color="132E4C"><strong>B&uacute;squeda Registro Embarcaciones Pesqueras</strong></font>
        </td>
    </tr>
</table>
<table class=formulario cellspacing=0>
    <tr>
        <td width="110">N&uacute;mero Matr&iacute;cula</td>
        <td width="135"><input type="text" name="area3EmbarcacionNumeroMatricula" style="width: 133" maxlength="15" onblur="sololet(this)"></td>
        <%--<td width="113"><input type="button" value="Buscar" onclick="doBuscar(3,50);"></td>--%>
        <td width="140">Nombre Embarcaci&oacute;n</td>
        <td width="135"><input type="text" name="area3EmbarcacionNombre" style="width: 133" maxlength="100" onblur="sololet(this)"></td>
        <td width="90"><div id="ocultar10"><A href="javascript:doBuscar(3,51)" onmouseover="javascript:mensaje_status('Busqueda de Registro de Embarcaciones Pesqueras');return true;" onmouseOut="javascript:mensaje_status(' ');return true;"><img border=0 src="images/btn_buscar2.gif"></a></div></td>
    </tr>
</table>
<br>
...
<table class=cabeceraformulario cellspacing=0>
    <tr bordercolor="AFAFAF" bgcolor="D7D7D7">
        <td><font color="132E4C"><strong>B&uacute;squeda Registro Buques</strong></font></td>
    </tr>
</table>
<table class=formulario cellspacing=0>
    <tr>
        <td width="110">N&uacute;mero Matr&iacute;cula</td>
        <td width="135"><input type="text" name="area3BuqueNumeroMatricula" style="width: 133" maxlength="15" onblur="sololet(this)"></td>
        <%--<td width="113" ><input type="button" value="Buscar" onclick="doBuscar(3,60);"></td>--%>
        <td width="140">Nombre Embarcaci&oacute;n</td>
        <td width="135"><input type="text" name="area3BuqueNombre" style="width: 133" maxlength="100" onblur="sololet(this)"></td>
        <td width="90"><div id="ocultar11"><A href="javascript:doBuscar(3,61)" onmouseover="javascript:mensaje_status('Busqueda de Registro de Buques');return true;" onmouseOut="javascript:mensaje_status(' ');return true;"><img border=0 src="images/btn_buscar2.gif"></a></div></td>
    </tr>
</table>
<br>
...
<table class=cabeceraformulario cellspacing=0>
    <tr bordercolor="AFAFAF" bgcolor="D7D7D7">
        <td width="673">
        <p align="left"><font color="132E4C"><strong>B&uacute;squeda Registro Aeronaves</strong></font>
        </td>
    </tr>
</table>
<table class=formulario cellspacing=0>
    <tr>
        <td width="106">N&uacute;mero Matr&iacute;cula</td>
        <td width="135"><input type="text" name="area3AeronaveNumeroMatricula" maxlength="15" style="width: 133" onblur="sololet(this)"></td>
        <td width="140">&nbsp;</td>
        <td width="135">&nbsp;</td>
        <td width="90"><div id="ocultar12"><A href="javascript:doBuscar(3,7)" onmouseover="javascript:mensaje_status('Busqueda de Registro de Aereonaves por Numero de Matricula');return true;" onmouseOut="javascript:mensaje_status(' ');return true;"><img border=0 src="images/btn_buscar2.gif"></a></div></td>
    </tr>
    <tr>
        <td colspan="5">
        <hr>
    ...
    <tr>
        <td width="110">Apellido Paterno</td>
        <td width="135"><input type="text" name="area3AeronaveApePat" maxlength="30" style="width: 133" onblur="sololet(this)"></td>
        <td width="140">Apellido Materno</td>
        <td width="135"><input type="text" name="area3AeronaveApeMat" maxlength="30" style="width: 133" onblur="sololet(this)"></td>
        <td width="90">&nbsp;</td>
    </tr>
    <tr>
        <td width="110">Nombres</td>
        <td width="135"><input type="text" name="area3AeronaveNombre" maxlength="40" style="width: 133" onblur="sololet(this)"></td>
        <td width="140">&nbsp;</td>
        <td width="135">&nbsp;</td>
        <td width="90"><div id="ocultar13"><A href="javascript:doBuscar(3,8)" onmouseover="javascript:mensaje_status('Busqueda de Registro de Aereonaves por Persona Natural');return true;" onmouseOut="javascript:mensaje_status(' ');return true;"><img border=0 src="images/btn_buscar2.gif"></a></div></td>
    </tr>
    <tr>
        <td colspan="5">
        <hr>
    ...
    <tr>
        <td width="110">Raz&oacute;n Social</td>
        <td width="135"><input type="text" name="area3AeronaveRazon" maxlength="150" style="width: 133" onblur="sololet(this)"></td>
        <td width="140">Siglas</td>
        <td width="135"><input type="text" name="area3SiglasB" maxlength="50" style="width: 133" onblur="sololet(this)"></td>
        <td width="90"><div id="ocultar14"><A href="javascript:doBuscar(3,9)" onmouseover="javascript:mensaje_status('Busqueda de Registro de Aereonaves por Organizacion');return true;" onmouseOut="javascript:mensaje_status(' ');return true;"><img border=0 src="images/btn_buscar2.gif"></a></div></td>
    </tr>
</table>
</div>
</layer>
...
<table class=cabeceraformulario cellspacing=0>
    <tr>
        <td>B&uacute;squeda Registro de Propiedad Mueble por Propietario</td>
    </tr>
</table>
<table class=formulario cellspacing=0>
...
--%>
    ...
    <tr>
        <td colspan=5><b>Buscar por Propietario Persona Natural</b></td>
    </tr>
    <tr>
        <td width="110">Apellido Paterno</td>
        <td width="135"><input type="text" name="area4PropietarioApePat" style="width: 130" maxlength="30" onblur="sololet(this)"></td>
        <td width="140">Apellido Materno</td>
        <td width="135"><input type="text" name="area4PropietarioApeMat" style="width: 130" maxlength="30" onblur="sololet(this)"></td>
        <td width="90">&nbsp;</td>
    </tr>
    <tr>
        <td width="110">Nombres</td>
        <td width="135"><input type="text" name="area4PropietarioNombre" style="width: 130" maxlength="40" onblur="sololet(this)"></td>
        <td width="140">&nbsp;</td>
        <td width="135">&nbsp;</td>
        <td width="90"><div id="ocultar15"><A href="javascript:doBuscar(4,1)" onmouseover="javascript:mensaje_status('Busqueda de Registro de Propiedad Inmueble por Nombre de Propietario Persona Natural');return true;" onmouseOut="javascript:mensaje_status(' ');return true;"><img border=0 src="<%=request.getContextPath()%>/images/btn_buscar2.gif"></a></div></td>
    </tr>

    <%if (flagInterno) { %>
    <tr>
        <td width="160"><input type="checkbox" name="checkInactivosPN4" checked> Incluir Inactivos</td>
        <td width="140">&nbsp;</td>
        <td width="160">&nbsp;</td>
        <td width="140">&nbsp;</td>
        <td width="31">&nbsp;</td>
    ...
    <tr>
        <td colspan=5><b>Buscar por Propietario Persona Juridica</b></td>
    </tr>
    <tr>
        <td width="110">Raz&oacute;n Social</td>
        <td width="135"><input type="text" name="area4PropietarioRazon" style="width: 130" maxlength="100" onblur="solonumlet(this)"></td>
        <td width="160">&nbsp;</td>
        <td width="140">&nbsp;</td>

        <td width="31"><div id="ocultar16"><A href="javascript:doBuscar(4,2)" onmouseover="javascript:mensaje_status('Busqueda de Registro de Propiedad Inmueble por Nombre de Propietario Persona Juridica');return true;" onmouseOut="javascript:mensaje_status(' ');return true;"><img border=0 src="<%=request.getContextPath()%>/images/btn_buscar2.gif"></a></div></td>


    </tr>
    <%if (flagInterno) { %>
    <tr>
        <td width="160"><input type="checkbox" name="checkInactivosPJ4" checked> Incluir Inactivos</td>
        <td width="140">&nbsp;</td>
        <td width="160">&nbsp;</td>
        <td width="140">&nbsp;</td>
        <td width="31">&nbsp;</td>
    ...
    <tr>
        <td colspan=5><b>Buscar por N&uacute;mero de Motor</b></td>
    </tr>
    <tr>
        <td width="110">N&uacute;mero de Motor</td>
        <td width="135"><input type="text" name="area4NumMotor" style="width: 130" maxlength="30" onblur="solonumlet(this)"></td>
        <td width="160">&nbsp;</td>
        <td width="140">&nbsp;</td>

        <td width="31"><div id="ocultar17"><A href="javascript:doBuscar(4,3)" onmouseover="javascript:mensaje_status('Busqueda de Registro de Propiedad Inmueble por Número de Motor');return true;" onmouseOut="javascript:mensaje_status(' ');return true;"><img border=0 src="<%=request.getContextPath()%>/images/btn_buscar2.gif"></a></div></td>


    </tr>
    <%if (flagInterno) { %>
    <tr>
        <td width="160"><input type="checkbox" name="checkInactivosNM4" checked> Incluir Inactivos</td>
        <td width="140">&nbsp;</td>
        <td width="160">&nbsp;</td>
        <td width="140">&nbsp;</td>
        <td width="31">&nbsp;</td>
    ...
    <tr>
        <td colspan=5><b>Buscar por Chasis</b></td>
    </tr>
    <tr>
        <td width="110">N&uacute;mero de Serie</td>
        <td width="135"><input type="text" name="area4Chasis" style="width: 130" maxlength="35" onblur="solonumlet(this)"></td>
        <td width="160">&nbsp;</td>
        <td width="140">&nbsp;</td>
        <td width="31"><div id="ocultar18"><A href="javascript:doBuscar(4,4)" onmouseover="javascript:mensaje_status('Busqueda de Registro de Propiedad Inmueble por Número de Chasis');return true;" onmouseOut="javascript:mensaje_status(' ');return true;"><img border=0 src="<%=request.getContextPath()%>/images/btn_buscar2.gif"></a></div></td>
    </tr>
    <%if (flagInterno) { %>
    <tr>
        <td width="160"><input type="checkbox" name="checkInactivosCH4" checked> Incluir Inactivos</td>
        <td width="140">&nbsp;</td>
        <td width="160">&nbsp;</td>
        <td width="140">&nbsp;</td>
        <td width="31">&nbsp;</td>
...
<div id="area12" style="visibility:visible">
	<table class=cabeceraformulario cellspacing=0>
	    <tr>
	        <td>B&uacute;squeda Registro Mobiliario de Contratos por Participante</td>
	    </tr>
	</table>
	<table class=formulario cellspacing=0>
   	    <tr>
	    ...
	    <tr>
	        <td width="110">Apellido Paterno</td>
	        <td width="135"><input type="text" name="txtApellidoPaterno" style="width: 130" maxlength="30" onblur="sololet(this)"></td>
	        <td width="140">Apellido Materno</td>
	        <td width="135"><input type="text" name="txtApellidoMaterno" style="width: 130" maxlength="30" onblur="sololet(this)"></td>
	        <td width="90">&nbsp;</td>
	    </tr>
	    <tr>
	        <td width="110">Nombres</td>
	        <td width="135"><input type="text" name="txtNombres" style="width: 130" maxlength="40" onblur="sololet(this)"></td>
	        <td width="140">&nbsp;</td>
	        <td width="135">&nbsp;</td>
	        <td width="90"><div id="ocultar19"><A href="javascript:doBuscarRMC(3,1)" onmouseover="javascript:mensaje_status('Busqueda de Registro de Mobiliario de Contratos por Nombre de Participante Persona Natural');return true;" onmouseOut="javascript:mensaje_status(' ');return true;"><img border=0 src="images/btn_buscar2.gif"></a></div></td>
	    </tr>
	    <tr>
	        <td colspan=5>
	           <hr>
	    ...
	    <tr>
	        <td width="110">Raz&oacute;n Social</td>
	        <td width="135"><input type="text" name="txtRazonSocial" style="width: 130" maxlength="150" onblur="solonumlet(this)"></td>
	        <td width="140">Siglas</td>
	        <td width="135"><input type="text" name="txtSiglas" style="width: 130" maxlength="60" onblur="sololet(this)"></td>
	        <td width="90"><div id="ocultar20"><A href="javascript:doBuscarRMC(3,2)" onmouseover="javascript:mensaje_status('Busqueda de Registro de Mobiliario de Contratos por Nombre de Participante Persona Juridica');return true;" onmouseOut="javascript:mensaje_status(' ');return true;"><img border=0 src="images/btn_buscar2.gif"></a></div></td>
	    </tr>
	    <tr>
	        <td colspan=5>
	           <hr>
	    ...
	    <tr>
	        <td colspan=5><b>Buscar por Tipo y Número de Documento</b></td>
	    </tr>
	    <tr>
	        ...
	        <td width="140">Número de Documento</td>
			<td width="135"><input type="text" name="txtNumeroDocumento" style="width: 130" maxlength="15"></td>
	        <td width="90"><div id="ocultar21"><A href="javascript:doBuscarRMC(3,3)" onmouseover="javascript:mensaje_status('Busqueda de Registro de Mobiliario de Contratos por Tipo y Número de Documento');return true;" onmouseOut="javascript:mensaje_status(' ');return true;"><img border=0 src="images/btn_buscar2.gif"></a></div></td>
	    </tr>
	    <%if (flagInterno==true) { %>
		    <tr>
		        <td colspan=5>
		    ...
		    <tr>
		        <td colspan=5><b>B&uacute;squeda por Bienes(*)</b></td>
		    </tr>
		    <tr>
		        <td width="110">Placa(Vehiculos)</td>
		        <td width="135"><input type="text" name="txtNumeroPlaca" style="width: 130" maxlength="7" onblur="sololet(this)"></td>
		        <td width="140">Otros datos</td>
		        <td width="135"><input type="text" name="txtOtrosDatos" style="width: 130" maxlength="100" onblur="sololet(this)"></td>
		        <td width="90"><div id="ocultar22"><A href="javascript:doBuscarRMC(3,4)" onmouseover="javascript:mensaje_status('Busqueda de Registro de Mobiliario de Contratos por Bienes');return true;" onmouseOut="javascript:mensaje_status(' ');return true;"><img border=0 src="images/btn_buscar2.gif"></a></div></td>
		    </tr>
		<% } %>  
	</table>
	<br>
	<table>
		<tr>
	       <td colspan="5"><font color=red>
	          (*)Ingresar datos sin guiones y sin espacios en blanco</font>
	       </td>
	    </tr>
	</table>
	<br>
...
<layer id="narea15" visibility="hide">
	...
	<table class=cabeceraformulario cellspacing=0>
	    <tr>
	        <td>Búsqueda del Sistema Integrado Garantias y Contratos por participante</td>
	    </tr>
	</table>
	<table class=formulario cellspacing=0>
	    <tr>
	    ...
	    <tr>
	        <td colspan=5><b>Búsqueda por Participante Persona Natural</b></td>
	    </tr>
	    <tr>
	        <td width="110">Apellido Paterno</td>
	        <td width="135"><input type="text" name="txtParticipanteApePatArea15" style="width: 130" maxlength="30" onblur="sololet(this)"></td>
	        <td width="140">Apellido Materno</td>
	        <td width="135"><input type="text" name="txtParticipanteApeMatArea15" style="width: 130" maxlength="30" onblur="sololet(this)"></td>
	        <td width="90">&nbsp;</td>
	    </tr>
	    <tr>
	        <td width="110">Nombres</td>
	        <td width="135"><input type="text" name="txtParticipanteNombreArea15" style="width: 130" maxlength="40" onblur="sololet(this)"></td>
	        <td width="140">&nbsp;</td>
	        <td width="135">&nbsp;</td>
	        <td width="90"><div id="ocultar23"><A href="javascript:doBuscarSIGC(4,1)" onmouseover="javascript:mensaje_status('Busqueda del Sistema Integrado Garantías y Contratos por Participante Persona Natural');return true;" onmouseOut="javascript:mensaje_status(' ');return true;"><img border=0 src="images/btn_buscar2.gif"></a></div></td>
	    </tr>
	    <tr>
	        <td colspan=5>
	        <hr>
	    ...
	    <tr>
	        <td colspan=5><b>Búsqueda por Participante Persona Juridica</b></td>
	    </tr>
	    <tr>
	        <td width="110">Razón Social</td>
	        <td width="135"><input type="text" name="txtParticipanteRazonArea15" style="width: 130" maxlength="150" onblur="solonumlet(this)"></td>
	        <td width="140">Siglas</td>
	        <td width="135"><input type="text" name="txtSiglasArea15" style="width: 130" maxlength="60" onblur="sololet(this)"></td>
	        <td width="90"><div id="ocultar24"><A href="javascript:doBuscarSIGC(4,2)" onmouseover="javascript:mensaje_status('Busqueda del Sistema Integrado Garantías y Contratos por Participante Persona Juridica');return true;" onmouseOut="javascript:mensaje_status(' ');return true;"><img border=0 src="images/btn_buscar2.gif"></a></div></td>
	    </tr>
	</table>
	<table class="formulario" cellspacing=0>	 
		<tr>
	    ...
	    <tr>
		 	<td colspan="5"><strong>Búsqueda por Tipo y Número de documento</strong></td>
	    </tr>
		<tr>
			<td width="110">Tipo</td>
	        <td width="135"> <select name="cboTipoDocumentoArea15">
              <option value=""> -- </option>
	        <logic:iterate name="arrDocu" id="item1" scope="request">
			  <option value="<bean:write name="item1" property="codigo"/>"> <bean:write name="item1" property="descripcion"/> </option>
			</logic:iterate>
	        ...
	        <td width="140">Número de Documento</td>
	        <td width="135"><input type="text" name="txtNumeroDocumentoArea15" maxlength="15"></td>
	        <td width="90"><div id="ocultar25"><A href="javascript:doBuscarSIGC(4,3)" onmouseover="javascript:mensaje_status('Busqueda del Sistema Integrado Garantías y Contratos por Tipo y Número de Documento');return true;" onmouseOut="javascript:mensaje_status(' ');return true;"><img border=0 src="images/btn_buscar2.gif"></a></div></td>
		 </tr>
	...
	<table class="formulario" cellspacing=0>
		 ...
		 <tr>
		 	<td colspan="5"><strong>Búsqueda por Bienes</strong></td>
		 </tr>
		 <tr>
		 	<td width="110">Placa</td>
		 	<td width="135"><input type="text" name="txtNumeroPlacaArea15" maxlength="15" onblur="mayuscula(this)"></td>
		 	<td width="140">Nro. Matricula(embarcaciones pesqueras, buques y aeronaves)</td>
		 	<td width="135"><input type="text" name="txtNumeroMatriculaArea15" maxlength="35" onblur="mayuscula(this)"></td>
			<td width="90"></td>        
		 </tr>
		 <tr>
		 	<td width="110">Nombre(embarcaciones pesqueras y buques)</td>
		 	<td width="135"><input type="text" name="txtNombreBienArea15" maxlength="15" onblur="mayuscula(this)"></td>
		 	<td width="140">Nro. Serie(motores aeronaves y otros)</td>
		 	<td width="135"><input type="text" name="txtNumeroSerieArea15" maxlength="35" onblur="mayuscula(this)"></td>
			<td width="90"><div id="ocultar26"><A href="javascript:doBuscarSIGC(4,4)" onmouseover="javascript:mensaje_status('Busqueda del Sistema Integrado Garantías y Contratos por Bienes');return true;" onmouseOut="javascript:mensaje_status(' ');return true;"><img border=0 src="images/btn_buscar2.gif"></a></div></td>
		 </tr>
