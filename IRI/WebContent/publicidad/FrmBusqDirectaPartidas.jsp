	...
	if	(tipob =='F')
		{
			...
			if (document.frm1.comboAreaLibro.value!=21){
				document.frm1.action="/iri/Publicidad.do?state=buscarXFicha";
			}else{
				document.frm1.action="/iri/Publicidad.do?state=buscarXFichaRMC";
			}	
		}
	if	(tipob =='P')
		{
			...
			if (document.frm1.comboAreaLibro.value!=21){
				document.frm1.action="/iri/Publicidad.do?state=buscarXNroPartida";
			}else{
				document.frm1.action="/iri/Publicidad.do?state=buscarXNroPartidaRMC";
			}		
		}
...
if	(param=='2')
	...
	// Fin:mgarate:29/05/2007
	if (document.frm1.comboAreaLibro.value!=21){
		document.frm1.action="/iri/Publicidad.do?state=buscarXTomoFolio";	
	}else{
		document.frm1.action="/iri/Publicidad.do?state=buscarXTomoFolioRMC";
	}	
	...
	if	(tipob =='F')
		{
			...
			document.frm1.action="/iri/Publicidad.do?state=buscarXPlaca";
		}
	if	(tipob =='P')
		{
...
<form name="frm1" method="POST">
	...
	<table class=titulo>
	  <tr> 
	    <td><font color="black">SERVICIOS &gt;&gt;</font>B&uacute;squeda Directa de Partidas</td>
	  </tr>
	</table>
	<br>
...
<tr> 
      <td align="right" width="50%">Oficina Registral </td>
      <td width="50%">
...
<br>
    ...
    <table class=formulario>
	  <tr> 
	    <td align="center">
	      <layer id="narea4">
            <div id="area4" style="visibility: visible;">	
	...
	<table class=formulario cellspacing=0>
      <tr> 
    	<td width="30%" class=formulario style="width:393px" align=right>Area Registral&nbsp;
		...
		<td width=2px></td>
		<td width="" class=cabeceraformulario style="width:200px;border-bottom-style:solid" align=right><font color=red><b>COSTO POR BUSQUEDA</b></font><input type="text" name="costo" size="2" value="0" disabled="true"></td>
      </tr>
	</table>
	<br>
<%
...
<div id="area1" style="position:absolute; left:<%=positionLeft%>px; top:<%=positionTop%>px; visibility: visible;">	
	...
	<table class=cabeceraformulario cellspacing=0>
      <tr> 
    	<td width="685" colspan="8" ><p align="left"><strong>B&uacute;squeda Directa por N&uacute;mero de Partida o de Ficha</strong></p></td>
      </tr>
	</table>
	<table class=formulario cellspacing=0>
	  <tr> 
		<td width="100">Buscar por	</td>
        <td align="left"> <input type="radio" value="F" checked name="radBuscar">Ficha&nbsp;&nbsp;<input type="radio" value="P" name="radBuscar">Partida</td>
		<td align="right"><a href="javascript:onclick=enviar('1','1')" onmouseover="javascript:mensaje_status('Busqueda Directa por Numero de Partida o de Ficha');return true;" onmouseOut="javascript:mensaje_status(' ');return true;"><img src="<%=request.getContextPath()%>/images/btn_buscar2.gif" border=0></a></td>        
	  </tr>
	  <tr> 
		<td width="100">N&uacute;mero</td>
		<td align= "left"><input type="text" name="txt1" size="12" maxlength="10"></td>
		<td>&nbsp;</td>		
	  </tr>
	  <tr> 
		<td width="100"></td>
	...
	<table class=cabeceraformulario cellspacing=0>
	  <tr > 
		<td><strong>B&uacute;squeda directa por Tomo/Folio</strong></td>
	  </tr>
	</table>
	<table class=formulario cellspacing=0>
	  <tr> 
		...
		<td >
    		<select name="combo3" style="width:400">
			</select>
		</td>
		<td align=right>
			<a href="javascript:onclick=enviar('1','2')" onmouseover="javascript:mensaje_status('Busqueda Directa por Tomo/Folio');return true;" onmouseOut="javascript:mensaje_status(' ');return true;"><img src="<%=request.getContextPath()%>/images/btn_buscar2.gif" border=0></a>
		</td>
	  </tr>
	  <tr> 
		<td width="100">Tomo</td>
		<td ><input type="text" name="txt2" size="20" maxlength="6"></td>
		<td >&nbsp;</td>
	  </tr>
	  <tr> 
		<td width="100">Folio</td>
		<td ><input type="text" name="txt3" size="20" maxlength="6"></td>
		<td >&nbsp;</td>
	  </tr>
	  <tr>
	 	<td colspan="3">&nbsp;</td>
	...
	<table class=formulario cellspacing=0>
	  <tr> 
        ...
        <td align="left">
          ...
          <input type="radio" value="P" name="radBuscar2" onClick="javascript:invisible_navegador(navegador,'area3','narea3','i');">Partida</td>
		<td align="right">
		  <a href="javascript:onclick=enviar('2','3')" onmouseover="javascript:mensaje_status('Busqueda Directa por Numero de Partida o de Placa');return true;" onmouseOut="javascript:mensaje_status(' ');return true;">
		    <img src="<%=request.getContextPath()%>/images/btn_buscar2.gif" border=0>
		  </a>
		</td>        
	  </tr>
	  <tr> 
