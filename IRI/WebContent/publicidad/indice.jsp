...
<link rel="stylesheet" type="text/css" href="<%=request.getContextPath()%>/styles/stylo1.css">
</head>
...
<logic:present name="asientos">
  <logic:iterate name="asientos" id="asiento">
    	...
    	function callVisualizar<%= contador %>(ultimo, imagenVisualizada, pagRef) 
    	{
			...
			parent.rigth.location = '/iri/Publicidad.do?state=muestraTituloVisualizacion'
				+ '&ultimo=' + ultimo
				+ '&contador=<%= contador %>'
...
{ %>
<a href="/iri/Publicidad.do?state=muestraIndiceAsientos&refnum_part=<%= request.getParameter("refnum_part") %>&orden=1">
Ordenar por rubro
</a>
<% } else { %>
<a href="/iri/Publicidad.do?state=muestraIndiceAsientos&refnum_part=<%= request.getParameter("refnum_part") %>">
Ordenar por fecha de inscripci&oacute;n
</a>
<% } %>
<%if(certi){%>
<table width="100%" border="1" cellpadding="1" cellspacing="2" bordercolor="#000000" bgcolor="#FFFFFF">
  <tr> 
    <td bordercolor="#000000" bgcolor="610000" colspan="2" align="center">
...
<% } %>
<table width="100%" border="1" cellpadding="1" cellspacing="2" bordercolor="#FFFFFF" bgcolor="#FFFFFF">
  <tr> 
    <td bordercolor="#000000" bgcolor="610000" class="txtCabecera">
      <%if(certi){
      		if(esRmc){
      %>
  ...
  <tr> 
    <td bordercolor="#000000" bgcolor="610000" class="txtCabecera">No. Pags. : <%=request.getAttribute("numPgnaTotal")%></td>
  </tr>
...
<%-- SI LA FICHA ESTA PRESENTE --%>
  ...
  <tr> 
    <td bordercolor="#000000" bgcolor="610000"><img src="<%=request.getContextPath()%>/images/space.gif" width="15" height="2"></td>
  </tr>
  <tr> 
