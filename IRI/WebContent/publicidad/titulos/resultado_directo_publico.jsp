...
function Ordenar(){ 
	...
	document.form1.action="/iri/BusquedaTituloPublico.do?state=buscaOrden&pagina=1";
	document.form1.submit();
}

function ShowReport(pagina){ 
	document.form1.method="POST";
	document.form1.action="/iri/BusquedaTituloPublico.do?state=buscaOrden&pagina=" + pagina;
	document.form1.submit();
}
...
<table class="titulo">
  <tr> 
    <td><font color="black">SERVICIOS &gt;&gt; Consulta de Estado de T&iacute;tulos &gt;&gt; </font>Resultado de T&iacute;tulo </td>
  </tr>
</table>
<br>
...
<table class="tablasinestilo">
  <tr> 
    <td valign="middle">
    <input type="checkbox" name="orden" <logic:present name="orden">checked</logic:present>> ORDENAR POR ESTADO&nbsp; <a href="javascript:Ordenar();" onmouseover="javascript:mensaje_status('Ordenar por Estado de Titulo');return true;" onmouseOut="javascript:mensaje_status(' ');return true;"><img src="<%=request.getContextPath()%>/images/btn_aplicar.gif" style="valign:middle" ></a>
    </td>
  </tr>
</table>
</logic:present>
...
<table class="grilla">
  <tr>
    <th width="10%">Presentante</th>
    <th width="6%">Ofic. Reg.</th>
    <th width="6%">A&ntilde;o</th>
    <th width="10%">T&iacute;tulo</th>
    <th width="8%">Tpo <br>Reg.</th>
    <!--No borrar
    	<th width="8%">Tipo Acto</th>
    -->
    <th width="10%">Acto Registral</th>
    <th width="7%">Partida</th>
    <th width="10%">Fec/Hor Pres.</th>
...
<%--    <td width="7%" align="center"><bean:write name="item1" property="sede"/></td> --%>
    <td width="9%" align="center" ><a href="/iri/BusquedaTituloPublico.do?state=buscarXNroTituloDet&oficinas=<%=item1.getReg_pub_id()%>|<%=item1.getOfic_reg_id()%>|<%=item1.getSede()%>&ano=<%=item1.getAno()%>&numtitu=<%=item1.getTitulo()%>&areareg=<%=item1.getArea_Reg()%>" onmouseover="javascript:mensaje_status('Ver Detalle');return true;" onmouseOut="javascript:mensaje_status(' ');return true;">Ver Detalle</a></td>
...
<table class="tablasinestilo">
  <tr> 
    <td align="right"><font color="red">Su b&uacute;squeda no contiene resultados.</font></td>
    <td align="right"><a href="javascript:Regresa();" onmouseover="javascript:mensaje_status('Regresar');return true;" onmouseOut="javascript:mensaje_status(' ');return true;"><img src="<%=request.getContextPath()%>/images/btn_regresa.gif" width="83" height="25" hspace="4" border="0" ></a></td>
  </tr>
</table>
</logic:notPresent>
