...
function busqdirectapornumero(){
	...
	document.form1.action = "/iri/BusquedaTituloVehicular.do?state=buscarXNroTitulo";
...
<table class=formulario cellspacing=0>
  ...
  <table class=formulario cellspacing=0>
    <tr> 
      <td align="center"><!--<a href="javascript:VentanaFlotante('/pics/acceso/mapas/MAPA1.htm')">Identifique su Oficina Registral</a>-->&nbsp;</td>
    </tr>
  </table>
 <br>
  ...
  <table class=formulario cellspacing=0>      
    <tr> 
      <td align="center" bordercolor="AFAFAF" bgcolor="F6F6F6" >
        <table width="95%" border="0" cellspacing="2" cellpadding="1">
          <tr bordercolor="#0000FF"> 
            ...
            <td>
              <input type="text" maxlength="8" onkeypress="return noenter()" name="numtitu" size="12" value="<logic:present name="ntdev"><logic:equal name="ntdev" value="2001"><bean:write name="ntdev"/></logic:equal></logic:present>">
            </td>
            <td align="center">
              <a href="javascript:busqdirectapornumero();">
                <IMG src="<%=request.getContextPath()%>/images/btn_buscar.gif" border="0">
              </A>
            </td>
          </tr>
        </table>
