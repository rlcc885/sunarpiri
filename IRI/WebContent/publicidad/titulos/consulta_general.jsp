...
function busqdirectapornumero(){
	...
	document.form1.action = "/iri/BusquedaTitulo.do?state=buscarXNroTitulo";
...
<body  background="<%=request.getContextPath()%>/images/bk_cuerpo.gif" onLoad="document.form1.reset(); CambioOficinaRegistralC(document.form1.CboOficinas.selectedIndex);"><br> 
<form name="form1">
<table width="608" border="0" cellpadding="0" cellspacing="2">
  <tr> 
      <td width="608" colspan="3"><b>SERVICIOS <font size="1"> &gt;&gt; </font><font color="900000"> Consulta de Estado de T&iacute;tulos</font></b></td>
  </tr>
  <tr> 
      <td width="683" colspan="3" bgcolor="#000000"><img src="../images/space.gif" width="5" height="1"></td>
  </tr>
</table>
    <SPAN id="combos">
<table width="600" border="1" bordercolor="#FFFFFF" dwcopytype="CopyTableRow">
<tr> 
      <td colspan="3" align="center" bordercolor="AFAFAF" bgcolor="F6F6F6"> &nbsp;Oficina 
        Registral 
  ...
  <table width="600" border="1" cellpadding="2" cellspacing="2" bordercolor="#FFFFFF">
    <tr> 
      <td width="600" align="center" bordercolor="AFAFAF" bgcolor="F6F6F6"><a href="javascript:VentanaFlotante('/iri/acceso/mapas/MAPA1.htm')">Identifique 
        su Oficina Registral</a> </td>
    </tr>
    <tr> 
    ...
    <tr> 
      <td align="center" bordercolor="AFAFAF" bgcolor="F6F6F6"><table width="95%" border="0" cellspacing="2" cellpadding="1">
          <tr bordercolor="#0000FF"> 
            ...
            <td><input type="text" name="numtitu" size="12" maxlength="8" onkeypress="return noenter()"></td>
            <td align="center">
            <A href="javascript:busqdirectapornumero();"><img border=0 src="<%=request.getContextPath()%>/images/btn_buscar.gif"></A>
            </td>
          </tr>
        </table></td>
    </tr>
