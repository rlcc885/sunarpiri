...
<table class=formulario cellspacing=0>
	...
	<tr>
		...
		<td width="65">
			<a href="javascript:validar();" onmouseover="javascript:mensaje_status('Buscar por Nombre de Persona Natural Presentante');return true;" onmouseOut="javascript:mensaje_status(' ');return true;">
			<IMG src="images/btn_solic.gif" border="0"> </A>
		</td>
	</tr>
	<tr>
		<td>&nbsp;</td>
	...
	<tr>
		...
		<table>
			<tr>
				...
				A nombre de quien saldrá el certificado</strong></td>
				<td>
					<table>
						<tr>
							...
							<td><input type="text" name="txtNom" size="20" maxlength="40"
		...
		<table>
			<tr>
				...
				A nombre de quien saldrá el certificado</strong></td>
				<td>
					 <input type="text" name="txtRazSoc" size="18" maxlength="120" style="width:407" onblur="sololet(this)">
				</td>
			</tr>
		</table>
		</div>
		...
		<table>
			...
			<tr>
				 <table>
					<tr>
						<td>&nbsp;</td>
						<td><strong>FECHA DE INSCRIPCION <br>
						 DE ASIENTO</strong></td>
						<td>desde</td>
			...
			<tr>
		   		<td>&nbsp;</td>
					<td><strong>TIPO DE PARTICIPACION*</strong></td>
					<td>
