...
<table class=titulo cellspacing=0>
	<tr>
		<td width="276"><font color=black>SERVICIOS &gt;&gt;</font>Publicidad
		Masiva Relacional</td>
	</tr>
	<tr>
		<td width="276" align="right"><input type="radio" name="resultado" value="D" onclick="javascript:group('D');"><strong>Detallado</strong></td>
		<td width="324"><input type="radio" name="resultado" value="C" checked="checked" onclick="javascript:group('C');"><strong>Consolidado</strong></td>
	</tr>
</table>
...
<table class=formulario cellspacing=2>
	<tr>
		...
		<td align="center" width="53">Hasta</td>
		<td width="135" align="left"><input type="text"
			name="fechaInscripcionHastaEmb" style="width: 133" maxlength="100"
			onblur="sololet(this)"></td>
		<td width="90" align="center"><A href="javascript:doBuscar(1,4)"
			...
			border=0 src="images/btn_buscar2.gif"></a></td>
	</tr>
	<tr>
...
<table class=formulario cellspacing=2>
	<tr>
		...
		<td width="90"><A href="javascript:doBuscar(1,3)"
...
<table class=formulario cellspacing=2>
	<tr>
		...
		<td width="135"><input type="text"
			...
			onblur="sololet(this)"></td>
		<td width="90"><A href="javascript:doBuscar(1,2)"
...
<table class=formulario cellspacing=2>
	<tr>
		...
		<td width="150"><input type="text"
			...
			onblur="sololet(this)"></td>
		<td width="90"><A href="javascript:doBuscar(1,5)"
...
<table class=formulario cellspacing=2>
	<tr>
		...
		<td align="right" width="136"><A href="javascript:doBuscar(1,1)"
