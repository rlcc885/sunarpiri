...
<table width="600" border="0" cellpadding="0" cellspacing="2">
  <tr> 
	...
	<logic:equal name="comprobante" property="tipoPub" value="S" scope="session">
        <b>PREPAGOS<font size="1">>></font><font color="#993300">Pago a cuenta</font></b>
    </logic:equal>
...
<table class=formulario>
  ...
  <tr>
    ...
    <td width="40%" height="14" colspan="2"><bean:write scope="session" name="comprobante" property="solDesc"/></td>
    <td width="20%" height="14" colspan="2"></td>
  </tr>
  </logic:notEqual>
  </logic:present>
  ...
  <tr>
    <th width="40%" height="14" colspan="2">GLOSA</th>
    <td width="40%" height="14" colspan="2"><bean:write scope="session" name="comprobante" property="glosa"/></td>
    <td width="20%" height="14" colspan="2"></td>
  </tr>
  <tr>
    <td width="40%" height="14" colspan="2"></td>
