...
function TipoPago(){ 
	...
	document.form1.codigoservicio = "100"; // Modificar antes de probar.
...
<table width="600" border="0" cellpadding="0" cellspacing="2">
  <tr> 
    <td><b>PREPAGOS<font size="1"></font> <font color="#90000">Pago a cuenta</font></b></td>
  </tr>
  <tr> 
  ...
  <tr align="center" bordercolor="C4C9CD" bgcolor="F0F0F0"> 
	<td>
	  <table border="0" width="80%">
		  ...
		  <tr>
			<td width="26%">&nbsp;Ingrese el Concepto </td>
			<td width="74%"><input name="glosa" maxlength="50"></td>
		  </tr>              
		</table>
	</td>
  </tr>
<table>
<font face="Verdana" size="1">IMPORTANTE: El monto ingresado es suceptible de ser utilizado para cualquier trámite realizado desde la Extranet.</font>
<p>
<font face="Verdana" size="1">Recuerde poner en el concepto un texto de referencia con respecto a su trámite.</font>
<p>
