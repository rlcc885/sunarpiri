...
<bean:define id="gd" property="medioId" type="java.lang.String"/>
  <table width="600" border="0" cellpadding="0" cellspacing="2">
    <tr> 
      <td><b>PREPAGOS<font size="1">>></font> <font color="#993300">Pago a Cuenta</font></b></td>
    </tr>
    <tr> 
            ...
            <td width="70%"><TABLE width="100%" border=0 cellSpacing=0>
                <TBODY>
                  <TR>
                     ...
                     <TD width="10%"> <DIV align=right><FONT face=Verdana size=1>Glosa:</FONT></DIV></TD>
                     <TD width=40%><bean:write property="glosa"/></TD>
                  </TR>
                </TBODY>
              </TABLE></td>
          </tr>
