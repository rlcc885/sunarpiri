...
ArrayList arrRubros = (ArrayList) session.getAttribute("ARR1");
...
<%if (modo==2 || modo==4) { %>
	...
	{
		alert("Por favor ingrese Codigo de Acto");
	...
	{
		alert("Por favor ingrese Codigo de Libro");
...
<table>
<tr>
	<td>C&oacute;digo Acto</td>
	<td><input type="text" name="val01" value="<%=bean.getValor01()%>" maxlength="5" size="6" disabled="true" onblur="sololet(this)"></td>
</tr>	
<tr>
	<td>Descripci&oacute;n</td>
	<td><input type="text" name="val02" value="<%=bean.getValor02()%>" maxlength="80" size="80" disabled="true" onblur="sololet(this)"></td>
</tr>	
<tr>
	<td>C&oacute;digo Libro</td>
	<td><input type="text" name="val03" value="<%=bean.getValor03()%>" maxlength="3" size="4" disabled="true" onblur="sololet(this)"></td>
</tr>	
<tr>
	<td>Rubro</td>
	<td>
      <select name="val04" disabled="true"> 
        <option value=" "> </option>
      <%for (int i = 0; i < arrRubros.size(); i++) 
      	{
      	ComboBean cbean = (ComboBean) arrRubros.get(i);%>
