...
ArrayList arrLibros  = (ArrayList) session.getAttribute("ARR1");
...
<%if (modo==2 || modo==4) { %>
	...
	{
		alert("Por favor ingrese Codigo de Participacion");
...
<tr>
	<td>Libro</td>
	<td>
      <select name="val01" disabled="true" style="width:500"> 
      <%for (int i = 0; i < arrLibros.size(); i++) 
      	{
      	ComboBean cbean = (ComboBean) arrLibros.get(i);%>
...
<tr>
	<td>C&oacute;digo Participaci&oacute;n</td>
	<td><input type="text" name="val02" value="<%=bean.getValor02()%>" maxlength="3" size="6" disabled="true" onblur="sololet(this)"></td>
</tr>	
<tr>
	<td>Estado</td>
	<td>
...
<tr>
	<td>Nombre</td>
	<td><input type="text" name="val04" value="<%=bean.getValor04()%>" maxlength="30" size="60" disabled="true" onblur="sololet(this)"></td>
</tr>	
</table>
</form>
