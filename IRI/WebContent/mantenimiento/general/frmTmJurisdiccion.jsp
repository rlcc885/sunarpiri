...
/*
	...
	{
		alert("Por favor ingrese correctamente Codigo de Jurisdiccion");
...
<table>
<tr>
	<td>C&oacute;digo Jurisdicci&oacute;n</td>
	<td><input type="text" name="val01" value="<%=bean.getValor01()%>" maxlength="10" size="20" disabled="true" onblur="sololet(this)"></td>
</tr>	
<tr>
	<td>Nombre</td>
	<td><input type="text" name="val02" value="<%=bean.getValor02()%>" maxlength="50" size="80" disabled="true" ></td>
</tr>	
<tr>
	<td>Estado</td>
	<td>
