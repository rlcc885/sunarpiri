...
ArrayList arrAreas  = (ArrayList) session.getAttribute("ARR1");
...
<tr>
	...
	<td><input type="text" name="val01" value="<%=bean.getValor01()%>" maxlength="3" size="6" disabled="true" onblur="sololet(this)"></td>
</tr>	
<tr>
	<td>Area Registral</td>
	<td>
      <select name="val02" disabled="true"> 
      <%for (int i = 0; i < arrAreas.size(); i++) 
      	{
      	ComboBean cbean = (ComboBean) arrAreas.get(i);%>
...
<tr>
	...
	<td><input type="text" name="val03" value="<%=bean.getValor02()%>" maxlength="120" size="80" disabled="true" onblur="sololet(this)"></td>
</tr>	
<tr>
	<td>Estado</td>
	<td>
