...
<%if (modo==2 || modo==4) { %>
	...
	{
		alert("Por favor ingrese Codigo de Rubro");
...
<tr>
	<td>Letra</td>
	<td><input type="text" name="val04" value="<%=bean.getValor04()%>" maxlength="1" size="2" disabled="true" onblur="sololet(this)"></td>
</tr>	
</table>
</form>
