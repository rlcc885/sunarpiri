...
ArrayList arrOficinas = (ArrayList) session.getAttribute("ARR3");
...
<%if (modo==2 || modo==4) { %>
	...
	{
		alert("Por favor ingrese Codigo de Provincia");
...
<tr>
	<td>C&oacute;digo Provincia</td>
	<td><input type="text" name="val03" value="<%=bean.getValor03()%>" maxlength="2" size="5" disabled="true" onblur="sololet(this)"></td>
</tr>	
<tr>
	<td>Nombre</td>
	<td><input type="text" name="val04" value="<%=bean.getValor04()%>" maxlength="40" size="60" disabled="true" onblur="sololet(this)"></td>
</tr>	
<tr>
	<td>Estado</td>
	<td>
      <select name="val05" disabled="true"> 
...
<%if (modo == 2 || modo == 4) {%>
	...
	<%if (modo==4) {%>	
		//PERU
		doCambiaCombo(document.frm1.val01,'01');
