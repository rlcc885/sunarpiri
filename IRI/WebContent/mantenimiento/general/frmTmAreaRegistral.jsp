...
<%if (modo==2 || modo==4) { %>
	...
	{
		alert("Por favor ingrese Codigo de Area");
	...
	{
		alert("Por favor ingrese Prefijo");
...
<table>
<tr>
	<td>C&oacute;digo &Aacute;rea</td>
	<td><input type="text" name="val01" value="<%=bean.getValor01()%>" maxlength="6" size="5" disabled="true" onblur="sololet(this)"></td>
</tr>	
<tr>
	<td>Nombre</td>
	<td><input type="text" name="val02" value="<%=bean.getValor02()%>" maxlength="60" size="30" disabled="true" onblur="sololet(this)"></td>
</tr>	
<tr>
	<td>Estado</td>
	<td>
...
<tr>
	...
	<td><input type="text" name="val04" value="<%=bean.getValor04()%>" maxlength="60" size="80" disabled="true" onblur="sololet(this)"></td>
</tr>	
<tr>
	<td>Prefijo</td>
	<td><input type="text" name="val05" value="<%=bean.getValor05()%>" maxlength="5" size="3" disabled="true" onblur="sololet(this)"></td>
</tr>	
</table>
</form>
