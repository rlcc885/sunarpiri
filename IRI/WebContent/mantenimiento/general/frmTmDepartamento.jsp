...
<%if (modo==2 || modo==4) { %>
	...
	{
		alert("Por favor ingrese el Codigo de departamento");
...
<tr>
	...
	<td><input type="text" name="val01" value="<%=bean.getValor01()%>" maxlength="2" size="6" disabled="true" onblur="sololet(this)"></td>
</tr>	
<tr>
	<td>Pa&iacute;s</td>
	<td>
...
<tr>
	<td>Nombre</td>
	<td><input type="text" name="val03" value="<%=bean.getValor02()%>" maxlength="30" size="60" disabled="true" onblur="sololet(this)"></td>
</tr>	
<tr>
	<td>Estado</td>
	<td>
