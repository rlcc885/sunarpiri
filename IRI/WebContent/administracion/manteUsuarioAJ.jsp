...
function validarformulario(){
	...
	*/	
	...
	if(document.form1.radio[4].checked==true){
			...
			if(esVacio(document.form1.tiempo.value) || !esNumero(document.form1.tiempo.value)){
...
<table border="0" width="100%" class="titulo">
	<tr>
		<td>
		<font color=black>ADMINISTRADOR JURISDICCI&Oacute;N &gt;&gt; Usuarios &gt;&gt; </font> Registro de Usuarios Individuales
		</td>
	</tr>
</table>
<br>
...
<table class="tablasinestilo">
  ...
  <tr>
    ...
    <td width="15%"><input type="image" src="images/btn_buscar.gif" border="0" onClick="return MuestraResultados();" onmouseover="javascript:mensaje_status('Buscar Usuario');return true;" onmouseOut="javascript:mensaje_status(' ');return true;"></td>
  </tr>
  <tr>
  ...
  <tr>
    ...
    <select size="1" name="numopt">
     ...
     </select>&nbsp; N&uacute;mero <input type="text" size="12" maxlength="15" name="numdoc" onblur="sololet(this)" onFocus="doCambiaRadio(document.form1.radio,'3');">
    </td>
  </tr>
  <tr>
  ...
  <tr>
    ...
    <td width="20%" align="right">
      <p align="left"><input type="text" maxlength="3"  size="3" name="tiempo" style="width:30" onblur="sololet(this)" onFocus="doCambiaRadio(document.form1.radio,'5');">dias</td>
    <td width="32%"></td>
    <td width="15%"></td>
  </tr>
  <tr>
    <td width="100%" colspan="4">
      <p align="center"><br>
      <A href="javascript:UsuarioNuevo()" onmouseover="javascript:mensaje_status('Crear Nuevo Usuario');return true;" onmouseOut="javascript:mensaje_status(' ');return true;"><img border=0 src="images/btn_nuevo.gif"></a>
      <!--<A href="javascript:history.back();"><img border=0 src="images/btn_regresa.gif"></a>-->
    </td>
  </tr>
</table>
<br>
