...
<table class="punteadoTabla" cellspacing=0 width="100%">
	<tr>
		<td class=formulario style="width: 200px" align="left" width="190">Area
		Registral:</td><td width="402"> <select name="comboAreaLibro" size="1"
...
<table class="punteadoTabla" class=cabeceraformulario cellspacing=0 width="100%">
	<tr bordercolor="AFAFAF" bgcolor="D7D7D7">
		...
		<p align="left"><font color="#949400"><strong>B&uacute;squeda
...
<table class="punteadoTabla" class=cabeceraformulario cellspacing=0 width="100%">
	<tr bordercolor="AFAFAF" bgcolor="D7D7D7">
		<td><font color="#949400"><strong>B&uacute;squeda
...
<table class="punteadoTabla" class=cabeceraformulario cellspacing=0>
	<tr bordercolor="AFAFAF" bgcolor="D7D7D7">
		<td width="673">
		<p align="left"><font color="#949400"><strong>Registro
